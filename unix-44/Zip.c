...
__TDESC(Zip_UncompReaderDesc__desc, 2, 2) = {__TDFLDS("UncompReaderDesc", 40), {8, 20, -12}};
__TDESC(Zip_DefReaderDesc__desc, 2, 10) = {__TDFLDS("DefReaderDesc", 556), {8, 32, 48, 104, 112, 492, 496, 512, 524, 536, -44}};
