...
static void __45 (void)
{
  ...
  if ((INTEGER)OfrontOPP_sym == 40) {
    ...
    __ASSERT(OfrontOPT_topScope != NIL, -1, (CHAR*)"OfrontOPP", 325662);
    __43();
    __ASSERT(OfrontOPT_topScope != NIL, -1, (CHAR*)"OfrontOPP", 326174);
...
static LONGINT __55 (OfrontOPT_Node A, OfrontOPT_Node B, LONGINT Step)
{
  __ASSERT((INTEGER)A->class == 7 && (INTEGER)B->class == 7, -1, (CHAR*)"OfrontOPP", 395318);
...
static void __63 (OfrontOPT_Node A, OfrontOPT_Node B, LONGINT Step)
{
  ...
  if ((INTEGER)cond != 0) {
    ...
    if ((INTEGER)cond < 0) {
      ...
      (*StatSeq__54_s->idtyp) = ((*StatSeq__54_s->id))->typ;
      __ASSERT((*StatSeq__54_s->idtyp) != NIL, -1, (CHAR*)"OfrontOPP", 407832);
