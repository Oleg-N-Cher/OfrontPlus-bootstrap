...
static void OfrontOPP_FixType (OfrontOPT_Struct struct_, OfrontOPT_Object obj, OfrontOPT_Struct typ, INTEGER pos)
{
  ...
  if (obj != NIL) {
    if ((INTEGER)obj->mode == 1) {
      ...
      __HALT(100, (CHAR*)"OfrontOPP", 45823);
    }
    obj->typ = typ;
  } else {
    if ((INTEGER)struct_->form == 13) {
      ...
      __HALT(100, (CHAR*)"OfrontOPP", 53759);
    }
    struct_->BaseTyp = typ;
  }
}
...
static void OfrontOPP_CheckForwardTypes (void)
{
  ...
  while (u != NIL) {
    next = u->next;
    __STRCOPYCC(u->name->data, name, __MIN(48, u->name->len[0]), (CHAR*)"OfrontOPP", 56354);
  ...
  if (__IN(obj->mode, 0xc2)) {
    if ((INTEGER)OfrontOPP_sym == 33) {
      ...
      if ((INTEGER)OfrontOPP_sym == 37 && (INTEGER)OfrontOPS_numtyp == 1) {
        ...
        (obj->entry->data)[__X(1, obj->entry->len[0], (CHAR*)"OfrontOPP", 89087)] = 0x00;
...
static void OfrontOPP_CheckSysFlag (SHORTINT *sysflag, SHORTINT default_, BOOLEAN record)
{
  ...
  if ((INTEGER)OfrontOPP_sym == 33) {
    ...
    if ((INTEGER)OfrontOPP_sym == 40 && (__STRCMPCC(OfrontOPS_name, (CHAR*)"notag", 6, (CHAR*)"OfrontOPP", 98054) == 0 || __STRCMPCC(OfrontOPS_name, (CHAR*)"untagged", 9, (CHAR*)"OfrontOPP", 98054) == 0)) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 1;
    } else if ((record && (INTEGER)OfrontOPP_sym == 40) && __STRCMPCC(OfrontOPS_name, (CHAR*)"noalign", 8, (CHAR*)"OfrontOPP", 93695) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 3;
    } else if ((record && (INTEGER)OfrontOPP_sym == 40) && __STRCMPCC(OfrontOPS_name, (CHAR*)"align2", 7, (CHAR*)"OfrontOPP", 94207) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 4;
    } else if ((record && (INTEGER)OfrontOPP_sym == 40) && __STRCMPCC(OfrontOPS_name, (CHAR*)"align4", 7, (CHAR*)"OfrontOPP", 94719) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 5;
    } else if ((record && (INTEGER)OfrontOPP_sym == 40) && __STRCMPCC(OfrontOPS_name, (CHAR*)"align8", 7, (CHAR*)"OfrontOPP", 95231) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 6;
    } else if ((record && (INTEGER)OfrontOPP_sym == 40) && __STRCMPCC(OfrontOPS_name, (CHAR*)"union", 6, (CHAR*)"OfrontOPP", 95743) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 7;
    } else {
...
static void OfrontOPP_CheckSysFlagVarPar (SHORTINT *sysflag)
{
  if ((INTEGER)OfrontOPP_sym == 33) {
    ...
    if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"nil", 4, (CHAR*)"OfrontOPP", 101126) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 1;
    } else {
      OfrontOPS_Get(&OfrontOPP_sym);
...
static void OfrontOPP_CheckSysFlagProc (SHORTINT *sysflag, BOOLEAN checkinline)
{
  if ((INTEGER)OfrontOPP_sym == 33) {
    ...
    if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"ccall", 6, (CHAR*)"OfrontOPP", 104966) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 0;
    } else if ((INTEGER)OfrontOPP_sym == 40 && (__STRCMPCC(OfrontOPS_name, (CHAR*)"stdcall", 8, (CHAR*)"OfrontOPP", 103935) == 0 || __STRCMPCC(OfrontOPS_name, (CHAR*)"callback", 9, (CHAR*)"OfrontOPP", 103935) == 0)) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 1;
    } else if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"fastcall", 9, (CHAR*)"OfrontOPP", 104191) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 2;
    } else if (((INTEGER)OfrontOPP_sym == 40 && checkinline) && __STRCMPCC(OfrontOPS_name, (CHAR*)"inline", 7, (CHAR*)"OfrontOPP", 104447) == 0) {
      OfrontOPS_Get(&OfrontOPP_sym);
      *sysflag = 3;
    } else {
      OfrontOPS_Get(&OfrontOPP_sym);
              ...
              if ((INTEGER)OfrontOPP_sym == 19) {
                ...
                if (y->obj != NIL) {
                  ...
                  if (p != NIL) {
                    ...
                    if (((INTEGER)p->vis == 2 && (INTEGER)p->mnolev < 0) && __STRCMPCC(proc->link->name->data, name, 48, (CHAR*)"OfrontOPP", 204031) != 0) {
                      OfrontOPP_err(196);
                    }
                  } else {
                    OfrontOPP_err(74);
...
static void OfrontOPP_String2Chars (OfrontOPT_Node a, OfrontOPT_Node *x)
{
  ...
  while (i <= _for__74) {
    if ((*x)->conval->intval + (LONGINT)i < (LONGINT)(*x)->conval->arr->val1->len[0]) {
      ((*x)->conval->arr->val1->data)[__X((*x)->conval->intval + (LONGINT)i, (*x)->conval->arr->val1->len[0], (CHAR*)"OfrontOPP", 237311)] = (BYTE)(a->conval->ext->data)[__X(i, a->conval->ext->len[0], (CHAR*)"OfrontOPP", 237311)];
    } else {
      OfrontOPP_err(64);
    }
    i += 1;
  ...
  if ((INTEGER)OfrontOPP_sym != 32 && __IN(typ->BaseTyp->form, 0x020008)) {
    ...
    if (((INTEGER)apar->typ->comp == 1 && __IN(apar->typ->form, 0x040400)) && apar->conval->intval2 <= typ->n) {
      ...
      if ((*x)->conval->intval < (LONGINT)(*x)->conval->arr->val1->len[0]) {
        ((*x)->conval->arr->val1->data)[__X((*x)->conval->intval, (*x)->conval->arr->val1->len[0], (CHAR*)"OfrontOPP", 242008)] = (BYTE)apar->conval->intval;
        (*x)->conval->intval += typ->n;
      } else {
        OfrontOPP_err(64);
      }
              ...
              switch (fp->typ->size) {
                case 1: 
                  if ((*x)->conval->intval + (LONGINT)i < (LONGINT)y->val1->len[0]) {
                    (y->val1->data)[__X((*x)->conval->intval + (LONGINT)i, y->val1->len[0], (CHAR*)"OfrontOPP", 249599)] = (BYTE)apar->conval->intval;
                  } else {
                    OfrontOPP_err(64);
                  }
                  break;
                case 2: 
                  if ((*x)->conval->intval + (LONGINT)i < (LONGINT)y->val2->len[0]) {
                    (y->val2->data)[__X((*x)->conval->intval + (LONGINT)i, y->val2->len[0], (CHAR*)"OfrontOPP", 250623)] = (SHORTINT)apar->conval->intval;
                  } else {
                    OfrontOPP_err(64);
                  }
                  break;
                case 4: 
                  if ((*x)->conval->intval + (LONGINT)i < (LONGINT)y->val4->len[0]) {
                    (y->val4->data)[__X((*x)->conval->intval + (LONGINT)i, y->val4->len[0], (CHAR*)"OfrontOPP", 251647)] = (INTEGER)apar->conval->intval;
                  } else {
                    OfrontOPP_err(64);
                  }
                  break;
                case 8: 
                  if ((*x)->conval->intval + (LONGINT)i < (LONGINT)y->val8->len[0]) {
                    (y->val8->data)[__X((*x)->conval->intval + (LONGINT)i, y->val8->len[0], (CHAR*)"OfrontOPP", 252671)] = apar->conval->intval;
                  } else {
                    OfrontOPP_err(64);
                  }
                  break;
                default: __CASECHK((CHAR*)"OfrontOPP", 252693);
              }
            }
            i += 1;
          } else {
    ...
    switch (OfrontOPS_numtyp) {
      ...
      case 4: 
        *x = OfrontOPB_NewRealConst(OfrontOPS_lrlval, OfrontOPT_lrltyp);
        break;
      default: __CASECHK((CHAR*)"OfrontOPP", 269055);
    }
    OfrontOPS_Get(&OfrontOPP_sym);
  } else if ((INTEGER)OfrontOPP_sym == 39) {
...
static void __40 (INTEGER len)
{
  ...
  if (len > ((*__37__38_s->s))->len[0]) {
    ...
    j = 0;
    while (j <= _for__42) {
      (s2->data)[__X(j, s2->len[0], (CHAR*)"OfrontOPP", 297793)] = (((*__37__38_s->s))->data)[__X(j, ((*__37__38_s->s))->len[0], (CHAR*)"OfrontOPP", 297793)];
      j += 1;
    }
    (*__37__38_s->s) = s2;
  }
...
static void __37 (void)
{
  ...
  for (;;) {
    if ((INTEGER)OfrontOPP_sym == 37) {
      ...
      OfrontOPS_Get(&OfrontOPP_sym);
      (s->data)[__X(n, s->len[0], (CHAR*)"OfrontOPP", 300585)] = (CHAR)c;
      n += 1;
    } else if ((INTEGER)OfrontOPP_sym == 39) {
      ...
      i = 0;
      while (i <= _for__39) {
        (s->data)[__X(n + i, s->len[0], (CHAR*)"OfrontOPP", 301620)] = (OfrontOPS_str->data)[__X(i, OfrontOPS_str->len[0], (CHAR*)"OfrontOPP", 301620)];
        i += 1;
      }
      OfrontOPS_Get(&OfrontOPP_sym);
      n += c;
  ...
  if (n != 0) {
    ...
    while (i < n) {
      (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPP", 303907)] = (s->data)[__X(i, s->len[0], (CHAR*)"OfrontOPP", 303907)];
      i += 1;
    }
  } else {
    ext = NIL;
...
static void __35 (void)
{
  ...
  *ProcedureDeclaration__34_s->x = procdec;
  ...
  OfrontOPP_CheckSym(43);
  if ((INTEGER)OfrontOPP_sym == 40) {
    if (__STRCMPCC(OfrontOPS_name, ((*ProcedureDeclaration__34_s->proc))->name->data, ((*ProcedureDeclaration__34_s->proc))->name->len[0], (CHAR*)"OfrontOPP", 313133) != 0) {
      OfrontOPP_err(4);
    }
    OfrontOPS_Get(&OfrontOPP_sym);
  } else {
...
static void __45 (void)
{
  ...
  if ((INTEGER)OfrontOPP_sym == 40) {
    ...
    __ASSERT(OfrontOPT_topScope != NIL, 0, (CHAR*)"OfrontOPP", 325406);
    __43();
    __ASSERT(OfrontOPT_topScope != NIL, 0, (CHAR*)"OfrontOPP", 325918);
  ...
  for (;;) {
    ...
    if ((INTEGER)i < 256) {
      for (;;) {
        ...
        if (tab[__X((INTEGER)i - 1, 256, (CHAR*)"OfrontOPP", 348680)].low <= yval) {
          if (tab[__X((INTEGER)i - 1, 256, (CHAR*)"OfrontOPP", 348207)].high >= xval) {
            OfrontOPP_err(62);
          }
          break;
        }
        tab[__X(i, 256, (CHAR*)"OfrontOPP", 348951)] = tab[__X((INTEGER)i - 1, 256, (CHAR*)"OfrontOPP", 348951)];
        i -= 1;
      }
      tab[__X(i, 256, (CHAR*)"OfrontOPP", 349462)].low = xval;
      tab[__X(i, 256, (CHAR*)"OfrontOPP", 349483)].high = yval;
      *n += 1;
    } else {
      OfrontOPP_err(213);
    }
...
static void __59 (OfrontOPT_Node *x)
{
  ...
  if ((INTEGER)(*x)->class == 8 || (INTEGER)(*x)->class == 9) {
    OfrontOPP_err(126);
  } else if (!__IN((*x)->typ->form, 0x02407a)) {
    OfrontOPP_err(125);
  }
  ...
  if ((INTEGER)n > 0) {
    low = tab[0].low;
    high = tab[__X((INTEGER)n - 1, 256, (CHAR*)"OfrontOPP", 357689)].high;
    if (high - low > 512) {
      OfrontOPP_err(209);
    }
  } else {
...
static LONGINT __55 (OfrontOPT_Node A, OfrontOPT_Node B, LONGINT Step)
{
  __ASSERT((INTEGER)A->class == 7 && (INTEGER)B->class == 7, 0, (CHAR*)"OfrontOPP", 383286);
  ...
  if (Nlast == 0) {
    ...
    switch (sgnPostLast) {
      ...
      case 1: 
        cond = 16;
        break;
      default: __CASECHK((CHAR*)"OfrontOPP", 388116);
    }
    ...
    if (OfrontOPP_Sign(Nlast) != sgnPostLast && OfrontOPP_Sign(A->conval->intval + Step) != sgnPostLast) {
      switch (sgnPostLast) {
        ...
        case 1: 
          ...
          break;
        default: __CASECHK((CHAR*)"OfrontOPP", 390219);
      }
    }
  }
  if ((((INTEGER)cond == 0 || (INTEGER)cond == 15) && OfrontOPP_Sign(Nlast) == OfrontOPP_Sign(Step)) && sgnPredLast != OfrontOPP_Sign(Nlast)) {
    switch (OfrontOPP_Sign(Nlast)) {
      ...
      case 1: 
        ...
        break;
      default: __CASECHK((CHAR*)"OfrontOPP", 392768);
    }
  }
  if ((INTEGER)cond != 0) {
    ...
    if ((INTEGER)cond < 0) {
      ...
      __ASSERT((*StatSeq__54_s->idtyp) != NIL, 0, (CHAR*)"OfrontOPP", 395800);
      ...
      while ((INTEGER)OfrontOPP_sym == 40) {
        ...
        if ((INTEGER)((*Block__3_s->obj))->typ->form == 13) {
          ...
          if (((*Block__3_s->typ) != NIL && (INTEGER)((*Block__3_s->typ))->comp == 4) && ((*Block__3_s->typ))->strobj == NIL) {
            __STRCOPYCC(((*Block__3_s->obj))->name->data, (*Block__3_s->rname), __MIN(48, ((*Block__3_s->obj))->name->len[0]), (CHAR*)"OfrontOPP", 500761);
            (*Block__3_s->i) = 0;
            while (((*Block__3_s->rname))[__X((*Block__3_s->i), 48, (CHAR*)"OfrontOPP", 501018)] != 0x00) {
              (*Block__3_s->i) += 1;
            }
            ((*Block__3_s->rname))[__X((*Block__3_s->i), 48, (CHAR*)"OfrontOPP", 501270)] = '^';
            ((*Block__3_s->rname))[__X((INTEGER)(*Block__3_s->i) + 1, 48, (CHAR*)"OfrontOPP", 501288)] = 0x00;
...
void OfrontOPP_Module (OfrontOPT_Node *prog, SET opt)
{
  ...
  if ((INTEGER)OfrontOPP_sym == 33) {
    OfrontOPS_Get(&OfrontOPP_sym);
    if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"foreign", 8, (CHAR*)"OfrontOPP", 525830) == 0) {
      OfrontOPM_opt = OfrontOPM_opt | 0xc000;
      OfrontOPS_Get(&OfrontOPP_sym);
    } else if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"main", 5, (CHAR*)"OfrontOPP", 524287) == 0) {
      OfrontOPM_opt |= __SETOF(10);
      OfrontOPS_Get(&OfrontOPP_sym);
    } else if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"noinit", 7, (CHAR*)"OfrontOPP", 524799) == 0) {
  ...
  if ((INTEGER)OfrontOPP_sym == 40) {
    ...
    OfrontOPS_Get(&OfrontOPP_sym);
    if (__STRLEN(OfrontOPS_name, 48, (CHAR*)"OfrontOPP", 527418) >= 32) {
      OfrontOPP_err(240);
    }
    OfrontOPP_CheckSym(41);
    if ((INTEGER)OfrontOPP_sym == 64) {
      ...
      for (;;) {
        if ((INTEGER)OfrontOPP_sym == 40) {
          __STRCOPYCC(OfrontOPS_name, aliasName, 48, (CHAR*)"OfrontOPP", 528668);
          __STRCOPYCC(aliasName, impName, 48, (CHAR*)"OfrontOPP", 528691);
          OfrontOPS_Get(&OfrontOPP_sym);
          if ((INTEGER)OfrontOPP_sym == 36) {
            OfrontOPS_Get(&OfrontOPP_sym);
            if ((INTEGER)OfrontOPP_sym == 40) {
              __STRCOPYCC(OfrontOPS_name, impName, 48, (CHAR*)"OfrontOPP", 529199);
              OfrontOPS_Get(&OfrontOPP_sym);
            } else {
              OfrontOPP_err(40);
            }
    ...
    if (OfrontOPM_noerr) {
      ...
      *prog = procdec;
      ...
      if ((INTEGER)OfrontOPP_sym == 68) {
        OfrontOPS_Get(&OfrontOPP_sym);
        OfrontOPP_StatSeq(&(*prog)->link);
      }
      OfrontOPP_CheckSym(43);
      if ((INTEGER)OfrontOPP_sym == 40) {
        if (__STRCMPCC(OfrontOPS_name, OfrontOPT_SelfName, 48, (CHAR*)"OfrontOPP", 533807) != 0) {
          OfrontOPP_err(4);
        }
        OfrontOPS_Get(&OfrontOPP_sym);
      } else {
...
__TDESC(OfrontOPP_Elem__rec__desc, 2, 5) = {__TDFLDS("Elem__rec", 24), {0, 4, 8, 12, 20, -24}};
__TDESC(OfrontOPP__1__desc, 2, 0) = {__TDFLDS("", 8), {-4}};
