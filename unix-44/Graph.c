...
__TDESC(Graph_BitmapDesc__desc, 3, 0) = {__TDFLDS("BitmapDesc", 12), {-4}};
__TDESC(Graph_MonoFontDesc__desc, 2, 2) = {__TDFLDS("MonoFontDesc", 24), {0, 20, -12}};
__TDESC(Graph_CharGeo__desc, 2, 0) = {__TDFLDS("CharGeo", 12), {-4}};
__TDESC(Graph_FontDesc__desc, 2, 1) = {__TDFLDS("FontDesc", 6156), {0, -8}};
__TDESC(Graph_Key__desc, 1, 0) = {__TDFLDS("Key", 16), {-4}};
__TDESC(Graph_Region__desc, 2, 0) = {__TDFLDS("Region", 16), {-4}};
__TDESC(Graph_Event__desc, 1, 0) = {__TDFLDS("Event", 80), {-4}};
__TDESC(Graph_EventQueue__desc, 2, 0) = {__TDFLDS("EventQueue", 20492), {-4}};
...
export void Graph__close (void)
{
/* CLOSE */
  __CLOSE(Out__init, Out__close);
}
