...
export void OfrontOPC_DoClose (void);
...
export void OfrontOPC_TypeDefs (OfrontOPT_Object obj, SHORTINT vis);
...
static void OfrontOPC_Str1 (CHAR *s, INTEGER s__len, INTEGER x)
{
  ...
  while (ch != 0x00) {
    ...
    i += 1;
    ch = s[__X(i, s__len, (CHAR*)"OfrontOPC", 41727)];
  }
}
...
static SHORTINT OfrontOPC_Length (CHAR *s, INTEGER s__len)
{
  SHORTINT i;
  i = 0;
  while (s[__X(i, s__len, (CHAR*)"OfrontOPC", 43281)] != 0x00) {
    i += 1;
  }
  return i;
}
...
static SHORTINT OfrontOPC_PerfectHash (CHAR *s, INTEGER s__len)
{
  ...
  i = 0;
  h = 0;
  while (s[__X(i, s__len, (CHAR*)"OfrontOPC", 45085)] != 0x00 && (INTEGER)i < 5) {
    h = (SHORTINT)(3 * (INTEGER)h + (INTEGER)s[__X(i, s__len, (CHAR*)"OfrontOPC", 45116)]);
    i += 1;
  }
...
static void OfrontOPC_WriteName (CHAR *s, INTEGER s__len)
{
  INTEGER i;
  CHAR ch;
  if (__STRCMPCC(s, (CHAR*)"Windows", 8, (CHAR*)"OfrontOPC", 48895) == 0) {
    ...
    while (ch != 0x00) {
      ...
      i += 1;
      ch = s[__X(i, s__len, (CHAR*)"OfrontOPC", 48383)];
    }
  }
}
...
void OfrontOPC_Ident (OfrontOPT_Object obj)
{
  ...
  OfrontOPS_String _ptr__69 = NIL;
  OfrontOPS_String _ptr__68 = NIL;
  mode = obj->mode;
  level = obj->mnolev;
  if (obj->entry != NIL && (INTEGER)level <= 0) {
    _ptr__72 = obj->entry;
    OfrontOPM_WriteString((void*)_ptr__72->data, _ptr__72->len[0]);
    if (OfrontOPM_currFile == 0 && (INTEGER)level < 0) {
      OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 51028)]->vis = 1;
    }
    ...
    h = (_ptr__70 = obj->name, 
      OfrontOPC_PerfectHash((void*)_ptr__70->data, _ptr__70->len[0]));
    if ((INTEGER)OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 53247)] >= 0) {
      if (__STRCMPCC(OfrontOPC_keytab[__X(OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 52991)], 37, (CHAR*)"OfrontOPC", 52991)], obj->name->data, obj->name->len[0], (CHAR*)"OfrontOPC", 52991) == 0) {
        OfrontOPM_Write('_');
      }
    }
    ...
    switch (obj->typ->form) {
      ...
      case 9: 
        ...
        break;
      default: __CASECHK((CHAR*)"OfrontOPC", 56319);
    }
  } else {
    if ((INTEGER)mode != 5 || obj->linkadr != 2) {
      if ((INTEGER)mode == 13) {
        ...
        if (!OfrontOPC_oldc) {
          _ptr__69 = OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 57855)]->name;
          OfrontOPM_WriteString((void*)_ptr__69->data, _ptr__69->len[0]);
        } else {
          OfrontOPM_Write((OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 58111)]->name->data)[0]);
        }
        if (OfrontOPM_currFile == 0) {
          OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 58465)]->vis = 1;
        }
    ...
    _ptr__68 = obj->name;
    OfrontOPC_WriteName((void*)_ptr__68->data, _ptr__68->len[0]);
  }
}
    ...
    if (__IN(typ->comp, 0x0c)) {
      ...
      *openClause = (INTEGER)typ->comp == 2;
      ...
      if ((INTEGER)typ->comp != 3 && t0 != typ->BaseTyp) {
        __ASSERT(t0 != typ, 0, (CHAR*)"OfrontOPC", 66375);
...
INTEGER OfrontOPC_NofPtrs (OfrontOPT_Struct typ)
{
  ...
  if ((INTEGER)typ->form == 13 && (INTEGER)typ->sysflag == 0) {
    ...
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if (__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 102407) != 0) {
  ...
  __RETCHK((CHAR*)"OfrontOPC", 104703);
}
...
static void OfrontOPC_PutPtrOffsets (OfrontOPT_Struct typ, INTEGER adr, INTEGER *cnt)
{
  ...
  if ((INTEGER)typ->form == 13 && (INTEGER)typ->sysflag == 0) {
    ...
    *cnt += 1;
    ...
    fld = typ->link;
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if (__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 109319) != 0) {
...
static void OfrontOPC_DeclareParams (OfrontOPT_Object par, BOOLEAN macro)
{
  ...
  while (par != NIL) {
    ...
    if ((INTEGER)par->typ->comp == 3 && !__ODD(par->typ->sysflag)) {
      ...
      OfrontOPM_WriteString((CHAR*)", ", 3);
      _ptr__25 = par->name;
      OfrontOPM_WriteString((void*)_ptr__25->data, _ptr__25->len[0]);
      OfrontOPM_WriteString((CHAR*)"__typ", 6);
    }
    par = par->link;
    if (par != NIL) {
...
{
  INTEGER i;
  __ASSERT(__IN(typ->comp, 0x0c), 0, (CHAR*)"OfrontOPC", 149541);
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    if (OfrontOPT_EqualType(typ, OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 150327)])) {
      return;
    }
    i += 1;
  }
  OfrontOPC_arrayTypes[__X(OfrontOPC_arrayIndex, 1024, (CHAR*)"OfrontOPC", 151071)] = typ;
...
void OfrontOPC_CleanupArrays (void)
{
  ...
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 153134)] = NIL;
    i += 1;
  }
}
...
static void OfrontOPC_DefineCyclicType (OfrontOPT_Struct str)
{
  ...
  if ((INTEGER)str->form == 15) {
  ...
  } else if (str == str->BaseTyp->BaseTyp && (INTEGER)str->form != 13) {
    if (str->BaseTyp->strobj == NIL) {
      OfrontOPM_WriteString((CHAR*)"typedef", 8);
      OfrontOPM_WriteLn();
      OfrontOPM_WriteTab();
      OfrontOPC_Indent(1);
    ...
    OfrontOPM_WriteLn();
    obj->linkadr = 4 + OfrontOPM_currFile;
  } else if ((INTEGER)str->BaseTyp->form == 16 && (INTEGER)str->BaseTyp->comp == 4) {
    obj->linkadr = 3;
  ...
  if (3 <= (INTEGER)sysflag && (INTEGER)sysflag <= 6) {
    ...
    switch (sysflag) {
      ...
      case 6: 
        OfrontOPM_Write('8');
        break;
      default: __CASECHK((CHAR*)"OfrontOPC", 164863);
    }
    OfrontOPM_Write(')');
    OfrontOPM_WriteLn();
  }
...
static BOOLEAN OfrontOPC_Prefixed (OfrontOPS_String x, CHAR *y, INTEGER y__len)
{
  INTEGER i;
  i = 0;
  while (i < x->len[0] && (x->data)[__X(i, x->len[0], (CHAR*)"OfrontOPC", 185380)] == y[__X(i, y__len, (CHAR*)"OfrontOPC", 185380)]) {
    i += 1;
  }
  return y[__X(i, y__len, (CHAR*)"OfrontOPC", 185855)] == 0x00;
}
  ...
  if (obj != NIL) {
    ...
    if (((INTEGER)obj->mode == 9 && (INTEGER)obj->vis >= (INTEGER)vis) && obj->adr == 1) {
      ...
      if (ext != NIL) {
        ...
        i = 0;
        while (i <= _for__11) {
          OfrontOPM_Write((ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPC", 189750)]);
          i += 1;
        }
      } else {
        OfrontOPM_WriteString((CHAR*)"import ", 8);
...
void OfrontOPC_TypeDefs (OfrontOPT_Object obj, SHORTINT vis)
{
  if (obj != NIL) {
...
{
  OfrontOPT_Object p = NIL;
  OfrontOPS_String _ptr__114 = NIL;
  if (check && typ == initial) {
  } else if (__IN(typ->form, 0x0243fe)) {
    if (typ->BaseTyp != OfrontOPT_undftyp) {
      typ = typ->BaseTyp;
    }
    _ptr__114 = typ->strobj->name;
    OfrontOPM_WriteString((void*)_ptr__114->data, _ptr__114->len[0]);
  } else if (typ == OfrontOPT_sysptrtyp) {
    OfrontOPC_Ident(typ->strobj);
  } else {
    if ((INTEGER)typ->comp == 4) {
      __ASSERT(typ->strobj != NIL && (typ->strobj->name->data)[0] != 0x00, 100, (CHAR*)"OfrontOPC", 209213);
      OfrontOPC_Ident(typ->strobj);
    } else if ((INTEGER)typ->comp == 2) {
      __ASSERT(typ->strobj != NIL && (typ->strobj->name->data)[0] != 0x00, 100, (CHAR*)"OfrontOPC", 209981);
      OfrontOPC_Ident(typ->strobj);
      ...
      __HALT(100, (CHAR*)"OfrontOPC", 214783);
    }
  }
}
...
static void OfrontOPC_DefAnonArrays (void)
{
  ...
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    atyp = OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 218392)];
    typ = atyp;
...
void OfrontOPC_TDescDecl (OfrontOPT_Struct typ)
{
  INTEGER nofptrs;
  OfrontOPT_Object o = NIL;
  OfrontOPS_String _ptr__106 = NIL;
  if (__MASK((INTEGER)typ->sysflag, -256) == 0) {
    ...
    OfrontOPM_Write('\"');
    if (typ->strobj != NIL) {
      _ptr__106 = typ->strobj->name;
      OfrontOPC_WriteName((void*)_ptr__106->data, _ptr__106->len[0]);
    }
...
static void OfrontOPC_FieldList (OfrontOPT_Struct typ, BOOLEAN last, INTEGER *off, INTEGER *n, INTEGER *curAlign)
{
  ...
  while (fld != NIL && (INTEGER)fld->mode == 4) {
    if ((OfrontOPM_currFile == 0 && (INTEGER)fld->vis == 0) || ((OfrontOPM_currFile == 1 && (INTEGER)fld->vis == 0) && (INTEGER)typ->mno != 0)) {
      fld = fld->link;
      while ((fld != NIL && (INTEGER)fld->mode == 4) && (INTEGER)fld->vis == 0) {
        fld = fld->link;
      }
    } else {
      adr = *off;
      ...
      *off = fld->adr + fld->typ->size;
      ...
      while ((((fld != NIL && (INTEGER)fld->mode == 4) && fld->typ == base) && fld->adr == *off) && ((OfrontOPM_currFile == 1 || (INTEGER)fld->vis != 0) || fld->typ->strobj == NIL)) {
        OfrontOPM_WriteString((CHAR*)", ", 3);
        OfrontOPC_DeclareObj(fld, 0);
        *off = fld->adr + fld->typ->size;
        fld = fld->link;
...
static BOOLEAN OfrontOPC_HasPtrs (OfrontOPT_Struct typ)
{
  ...
  if (__IN(typ->form, 0xa000)) {
    ...
    fld = typ->link;
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if ((__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 262251) == 0 || __STRCMPCC(fld->name->data, (CHAR*)"@proc", 6, (CHAR*)"OfrontOPC", 262251) == 0) || OfrontOPC_HasPtrs(fld->typ)) {
        return 1;
      }
      fld = fld->link;
    }
...
static struct WriteConstArr__117 {
  struct WriteConstArr__117 *lnk;
} *WriteConstArr__117_s;

static void __120 (OfrontOPT_ConstArr arr, INTEGER i, OfrontOPT_Struct bt);
  ...
  switch (bt->size) {
    case 1: 
      if (__IN(bt->form, 0x4008)) {
        OfrontOPM_WriteInt(__MASK((INTEGER)(arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 266830)], -256));
      } else {
        OfrontOPM_WriteInt((arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 266861)]);
      }
      break;
    case 2: 
      if ((INTEGER)bt->form == 17) {
        OfrontOPM_WriteInt(__MASK((INTEGER)(arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 267079)], -65536));
      } else {
        OfrontOPM_WriteInt((arr->val2->data)[__X(i, arr->val2->len[0], (CHAR*)"OfrontOPC", 267110)]);
      }
      break;
    case 4: 
      OfrontOPM_WriteInt((arr->val4->data)[__X(i, arr->val4->len[0], (CHAR*)"OfrontOPC", 267519)]);
      break;
    case 8: 
      OfrontOPM_WriteInt((arr->val8->data)[__X(i, arr->val8->len[0], (CHAR*)"OfrontOPC", 267775)]);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 267775);
  }
}
...
static void OfrontOPC_WriteConstArr (OfrontOPT_Object *obj, OfrontOPT_Struct typ)
{
  ...
  INTEGER i, _for__119, _for__118;
  struct WriteConstArr__117 _s;
  _s.lnk = WriteConstArr__117_s;
  WriteConstArr__117_s = &_s;
  ...
  if ((INTEGER)typ->BaseTyp->form != 16) {
    ...
    i = 0;
    while (i <= _for__119) {
      __120((*obj)->conval->arr, i + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
      OfrontOPM_WriteString((CHAR*)",", 2);
      if (__MOD(i + 1, 10) == 0) {
        OfrontOPM_WriteLn();
        OfrontOPC_BegStat();
    ...
    __120((*obj)->conval->arr, (typ->n - 1) + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
...
static void OfrontOPC_ProcHeader (OfrontOPT_Object proc, BOOLEAN define)
{
  ...
  if ((INTEGER)proc->sysflag == 3) {
    OfrontOPM_WriteString((CHAR*)"inline ", 8);
  }
...
static void OfrontOPC_IncludeImports (SHORTINT vis)
{
  ...
  while (i < (INTEGER)OfrontOPT_nofGmod) {
    mod = OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 318487)];
    if ((INTEGER)mod->vis >= (INTEGER)vis) {
      _ptr__76 = mod->name;
      OfrontOPC_Include((void*)_ptr__76->data, _ptr__76->len[0]);
      if (__STRCMPCC(mod->name->data, (CHAR*)"WinApi", 7, (CHAR*)"OfrontOPC", 319487) == 0) {
        OfrontOPC_windows = 1;
      }
    }
    i += 1;
...
void OfrontOPC_GenBdy (OfrontOPT_Node n)
{
  ...
  OfrontOPM_WriteLn();
  if ((OfrontOPC_mainprog && !OfrontOPC_dynlib) && __IN(19, OfrontOPM_opt)) {
...
static void OfrontOPC_RegCmds (OfrontOPT_Object obj)
{
  OfrontOPS_String _ptr__100 = NIL;
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 7 && (INTEGER)obj->history != 4) {
      if (((INTEGER)obj->vis != 0 && obj->link == NIL) && obj->typ == OfrontOPT_notyp) {
        ...
        _ptr__100 = obj->name;
        OfrontOPM_WriteString((void*)_ptr__100->data, _ptr__100->len[0]);
        OfrontOPM_WriteString((CHAR*)"\", ", 4);
        OfrontOPC_Ident(obj);
        OfrontOPM_Write(')');
        OfrontOPC_EndStat();
...
static void OfrontOPC_InitImports (OfrontOPT_Object obj)
{
  ...
  if (obj != NIL) {
    ...
    if (((INTEGER)obj->mode == 11 && (INTEGER)obj->mnolev != 0) && !__ODD(OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 353286)]->sysflag)) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__IMPORT(", 10);
      _ptr__81 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 352819)]->name;
      OfrontOPM_WriteString((void*)_ptr__81->data, _ptr__81->len[0]);
...
void OfrontOPC_EnterBody (void)
{
  ...
  if (OfrontOPC_mainprog && !OfrontOPC_dynlib) {
    ...
    if (OfrontOPC_mainprog) {
      OfrontOPM_WriteString((CHAR*)"__BEGIN void ", 14);
    } else if (OfrontOPC_dynlib) {
  ...
  OfrontOPC_EndStat();
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPC", 372479) != 0) {
    OfrontOPC_RegCmds(OfrontOPT_topScope);
  }
}

/*----------------------------------------------------------------------------*/
void OfrontOPC_DoClose (void)
{
  INTEGER i;
  OfrontOPS_String _ptr__41 = NIL;
  if (__IN(19, OfrontOPM_opt)) {
    OfrontOPC_BegStat();
    OfrontOPM_WriteString((void*)OfrontOPM_modName, 32);
  ...
  i = 0;
  while (i < 64 && OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 375349)] != NIL) {
    if ((INTEGER)OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 376582)]->sysflag < 0) {
      OfrontOPC_BegStat();
      _ptr__41 = OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 376104)]->name;
      OfrontOPM_WriteString((void*)_ptr__41->data, _ptr__41->len[0]);
      OfrontOPM_WriteString((CHAR*)"__close()", 10);
      OfrontOPC_EndStat();
    }
    i += 1;
...
void OfrontOPC_DefineInter (OfrontOPT_Object proc)
{
  ...
  OfrontOPM_Write('*');
  _ptr__33 = scope->name;
  OfrontOPM_WriteString((void*)_ptr__33->data, _ptr__33->len[0]);
...
void OfrontOPC_EnterProc (OfrontOPT_Object proc)
{
  ...
  OfrontOPS_String _ptr__49 = NIL;
  OfrontOPS_String _ptr__48 = NIL;
  if ((INTEGER)proc->vis != 1) {
    OfrontOPM_WriteString((CHAR*)"static ", 8);
  }
  ...
  if (!scope->leaf) {
    ...
    OfrontOPM_WriteString((CHAR*)" = ", 4);
    _ptr__49 = scope->name;
    OfrontOPM_WriteString((void*)_ptr__49->data, _ptr__49->len[0]);
    OfrontOPM_WriteString((CHAR*)"_s", 3);
    OfrontOPC_EndStat();
    OfrontOPC_BegStat();
    _ptr__48 = scope->name;
    OfrontOPM_WriteString((void*)_ptr__48->data, _ptr__48->len[0]);
    OfrontOPM_WriteString((CHAR*)"_s", 3);
    OfrontOPM_WriteString((CHAR*)" = ", 4);
    OfrontOPM_Write('&');
    OfrontOPM_WriteString((CHAR*)"_s", 3);
...
void OfrontOPC_ExitProc (OfrontOPT_Object proc, BOOLEAN eoBlock, BOOLEAN implicitRet)
{
  ...
  if (implicitRet && proc->typ != OfrontOPT_notyp) {
    ...
    if (!proc->scope->leaf) {
      ...
      _ptr__54 = proc->scope->name;
      OfrontOPM_WriteString((void*)_ptr__54->data, _ptr__54->len[0]);
      OfrontOPM_WriteString((CHAR*)"_s", 3);
      OfrontOPM_WriteString((CHAR*)" = ", 4);
      OfrontOPM_WriteString((CHAR*)"_s", 3);
      OfrontOPM_Write('.');
...
{
  OfrontOPS_String _ptr__109 = NIL;
  __ASSERT((INTEGER)ap->typ->comp == 4, 0, (CHAR*)"OfrontOPC", 438046);
  if ((INTEGER)ap->mode == 2) {
    if ((INTEGER)ap->mnolev != OfrontOPM_level) {
      _ptr__109 = ap->scope->name;
      OfrontOPM_WriteString((void*)_ptr__109->data, _ptr__109->len[0]);
...
void OfrontOPC_Cmp (SHORTINT rel)
{
  switch (rel) {
    ...
    case 16: 
      OfrontOPM_WriteString((CHAR*)" >= ", 5);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 445212);
  }
}
...
static void OfrontOPC_WriteCharLiteral (LONGCHAR ch, BOOLEAN wide)
{
  if (ch >= ' ' && ch <= '~') {
    ...
    __ASSERT(ch <= 0xff, 0, (CHAR*)"OfrontOPC", 448533);
    OfrontOPM_WriteString((CHAR*)"0x", 3);
...
static void OfrontOPC_WriteStringLiteral (CHAR *str, INTEGER str__len, INTEGER len)
{
  ...
  i = 0;
  while (i < len) {
    ch = str[__X(i, str__len, (CHAR*)"OfrontOPC", 450847)];
    if (ch >= ' ' && ch <= '~') {
      if (((ch == '\\' || ch == '\?') || ch == '\'') || ch == '\"') {
        OfrontOPM_Write('\\');
      }
      ...
      if (i + 1 < len) {
        switch (str[__X(i + 1, str__len, (CHAR*)"OfrontOPC", 452884)]) {
...
void OfrontOPC_Case (INTEGER caseVal, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 1: case 14: case 4: case 5: case 6: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 457727);
  }
  OfrontOPM_WriteString((CHAR*)": ", 3);
}
...
void OfrontOPC_Constant (OfrontOPT_Const con, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 11: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 477695);
  }
}

/*----------------------------------------------------------------------------*/
static struct InitKeywords__82 {
  SHORTINT *n;
  struct InitKeywords__82 *lnk;
} *InitKeywords__82_s;

static void __83 (CHAR *s, INTEGER s__len);

static void __83 (CHAR *s, INTEGER s__len)
{
  SHORTINT h;
  h = OfrontOPC_PerfectHash((void*)s, s__len);
  OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 480044)] = (*InitKeywords__82_s->n);
  __STRCOPYCC(s, OfrontOPC_keytab[__X((*InitKeywords__82_s->n), 37, (CHAR*)"OfrontOPC", 480061)], __MIN(9, s__len), (CHAR*)"OfrontOPC", 480061);
  (*InitKeywords__82_s->n) += 1;
}

static void OfrontOPC_InitKeywords (void)
{
  SHORTINT n, i;
  struct InitKeywords__82 _s;
  _s.n = &n;
  _s.lnk = InitKeywords__82_s;
  InitKeywords__82_s = &_s;
  n = 0;
  i = 0;
  while ((INTEGER)i <= 168) {
    OfrontOPC_hashtab[__X(i, 169, (CHAR*)"OfrontOPC", 481076)] = -1;
    i += 1;
  }
  __83((CHAR*)"asm", 4);
  __83((CHAR*)"auto", 5);
  ...
  __83((CHAR*)"typedef", 8);
  __83((CHAR*)"union", 6);
  __83((CHAR*)"unsigned", 9);
  __83((CHAR*)"void", 5);
  __83((CHAR*)"volatile", 9);
  __83((CHAR*)"while", 6);
  InitKeywords__82_s = _s.lnk;
}
...
export void *OfrontOPC__init (void)
{
  ...
  __REGCMD("DoClose", OfrontOPC_DoClose);
