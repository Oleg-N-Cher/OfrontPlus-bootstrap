...
static void OfrontOPC_IncludeImports (SHORTINT vis)
{
  ...
  while (i < (INTEGER)OfrontOPT_nofGmod) {
    mod = OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 317975)];
    if ((INTEGER)mod->vis >= (INTEGER)vis) {
      _ptr__77 = mod->name;
      OfrontOPC_Include((void*)_ptr__77->data, _ptr__77->len[0]);
      if (__STRCMPCC(mod->name->data, (CHAR*)"WinApi", 7, (CHAR*)"OfrontOPC", 318975) == 0) {
        OfrontOPC_windows = 1;
      }
    }
    i += 1;
...
static void OfrontOPC_InitImports (OfrontOPT_Object obj)
{
  ...
  if (obj != NIL) {
    ...
    if (((INTEGER)obj->mode == 11 && (INTEGER)obj->mnolev != 0) && !__ODD(OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 352774)]->sysflag)) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__IMPORT(", 10);
      _ptr__82 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 352307)]->name;
...
void OfrontOPC_EnterBody (void)
{
  ...
  OfrontOPC_EndStat();
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPC", 371967) != 0) {
...
static void OfrontOPC_DoClose (OfrontOPT_Object obj)
{
  ...
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 11 && __ODD(__ASHR((INTEGER)OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 374790)]->sysflag, 1, INTEGER))) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__CLOSE(", 9);
      _ptr__42 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 374067)]->name;
      OfrontOPM_WriteString((void*)_ptr__42->data, _ptr__42->len[0]);
      OfrontOPM_WriteString((CHAR*)"__init, ", 9);
      _ptr__41 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 374323)]->name;
...
void OfrontOPC_TypeOf (OfrontOPT_Object ap)
{
  ...
  __ASSERT((INTEGER)ap->typ->comp == 4, 0, (CHAR*)"OfrontOPC", 438302);
...
void OfrontOPC_Cmp (SHORTINT rel)
{
  switch (rel) {
    ...
    case 16: 
      OfrontOPM_WriteString((CHAR*)" >= ", 5);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 445468);
  }
}
...
static void OfrontOPC_WriteCharLiteral (LONGCHAR ch, BOOLEAN wide)
{
  if (ch >= ' ' && ch <= '~') {
    ...
    __ASSERT(ch <= 0xff, 0, (CHAR*)"OfrontOPC", 448789);
    OfrontOPM_WriteString((CHAR*)"0x", 3);
...
static void OfrontOPC_WriteStringLiteral (CHAR *str, INTEGER str__len, INTEGER len)
{
  ...
  i = 0;
  while (i < len) {
    ch = str[__X(i, str__len, (CHAR*)"OfrontOPC", 451103)];
    if (ch >= ' ' && ch <= '~') {
      if (((ch == '\\' || ch == '\?') || ch == '\'') || ch == '\"') {
        OfrontOPM_Write('\\');
      }
      ...
      if (i + 1 < len) {
        switch (str[__X(i + 1, str__len, (CHAR*)"OfrontOPC", 453140)]) {
...
void OfrontOPC_Case (INTEGER caseVal, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 1: case 14: case 4: case 5: case 6: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 457983);
  }
  OfrontOPM_WriteString((CHAR*)": ", 3);
}
...
void OfrontOPC_Constant (OfrontOPT_Const con, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 11: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 477951);
  }
}
...
static void __84 (CHAR *s, INTEGER s__len)
{
  ...
  OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 480300)] = (*InitKeywords__83_s->n);
  __STRCOPYCC(s, OfrontOPC_keytab[__X((*InitKeywords__83_s->n), 37, (CHAR*)"OfrontOPC", 480317)], __MIN(9, s__len), (CHAR*)"OfrontOPC", 480317);
...
static void OfrontOPC_InitKeywords (void)
{
  ...
  i = 0;
  while ((INTEGER)i <= 168) {
    OfrontOPC_hashtab[__X(i, 169, (CHAR*)"OfrontOPC", 481332)] = -1;
    i += 1;
  }
  __84((CHAR*)"asm", 4);
  __84((CHAR*)"auto", 5);
