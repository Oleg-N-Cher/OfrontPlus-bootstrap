...
void OfrontOPC_Ident (OfrontOPT_Object obj)
{
  ...
  OfrontOPS_String _ptr__67 = NIL;
  OfrontOPS_String _ptr__66 = NIL;
  mode = obj->mode;
  level = obj->mnolev;
  if (obj->entry != NIL && (INTEGER)level <= 0) {
    _ptr__70 = obj->entry;
    OfrontOPM_WriteString((void*)_ptr__70->data, _ptr__70->len[0]);
    ...
    h = (_ptr__68 = obj->name, 
      OfrontOPC_PerfectHash((void*)_ptr__68->data, _ptr__68->len[0]));
    ...
    if ((INTEGER)mode != 5 || obj->linkadr != 2) {
      if ((INTEGER)mode == 13) {
        ...
        if (!OfrontOPC_oldc) {
          _ptr__67 = OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 57855)]->name;
          OfrontOPM_WriteString((void*)_ptr__67->data, _ptr__67->len[0]);
        } else {
    ...
    _ptr__66 = obj->name;
    OfrontOPC_WriteName((void*)_ptr__66->data, _ptr__66->len[0]);
  }
}
...
{
  OfrontOPT_Object p = NIL;
  OfrontOPS_String _ptr__112 = NIL;
  if (check && typ == initial) {
  } else if (__IN(typ->form, 0x0243fe)) {
    if (typ->BaseTyp != OfrontOPT_undftyp) {
      typ = typ->BaseTyp;
    }
    _ptr__112 = typ->strobj->name;
    OfrontOPM_WriteString((void*)_ptr__112->data, _ptr__112->len[0]);
...
void OfrontOPC_TDescDecl (OfrontOPT_Struct typ)
{
  INTEGER nofptrs;
  OfrontOPT_Object o = NIL;
  OfrontOPS_String _ptr__104 = NIL;
  if (__MASK((INTEGER)typ->sysflag, -256) == 0) {
    ...
    OfrontOPM_Write('\"');
    if (typ->strobj != NIL) {
      _ptr__104 = typ->strobj->name;
      OfrontOPC_WriteName((void*)_ptr__104->data, _ptr__104->len[0]);
    }
...
static struct WriteConstArr__115 {
  struct WriteConstArr__115 *lnk;
} *WriteConstArr__115_s;

static void __118 (OfrontOPT_ConstArr arr, INTEGER i, OfrontOPT_Struct bt);
...
static void OfrontOPC_WriteConstArr (OfrontOPT_Object *obj, OfrontOPT_Struct typ)
{
  ...
  INTEGER i, _for__117, _for__116;
  struct WriteConstArr__115 _s;
  _s.lnk = WriteConstArr__115_s;
  WriteConstArr__115_s = &_s;
  ...
  if ((INTEGER)typ->BaseTyp->form != 16) {
    ...
    i = 0;
    while (i <= _for__117) {
      __118((*obj)->conval->arr, i + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
      OfrontOPM_WriteString((CHAR*)",", 2);
      if (__MOD(i + 1, 10) == 0) {
        OfrontOPM_WriteLn();
        OfrontOPC_BegStat();
    ...
    __118((*obj)->conval->arr, (typ->n - 1) + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
...
static void OfrontOPC_IncludeImports (SHORTINT vis)
{
  ...
  while (i < (INTEGER)OfrontOPT_nofGmod) {
    ...
    if ((INTEGER)mod->vis >= (INTEGER)vis) {
      _ptr__74 = mod->name;
      OfrontOPC_Include((void*)_ptr__74->data, _ptr__74->len[0]);
  ...
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 7 && (INTEGER)obj->history != 4) {
      if (((INTEGER)obj->vis != 0 && obj->link == NIL) && obj->typ == OfrontOPT_notyp) {
        ...
        _ptr__98 = obj->name;
        OfrontOPM_WriteString((void*)_ptr__98->data, _ptr__98->len[0]);
        OfrontOPM_WriteString((CHAR*)"\", ", 4);
        OfrontOPC_Ident(obj);
        OfrontOPM_Write(')');
        OfrontOPC_EndStat();
...
static void OfrontOPC_InitImports (OfrontOPT_Object obj)
{
  ...
  if (obj != NIL) {
    ...
    if (((INTEGER)obj->mode == 11 && (INTEGER)obj->mnolev != 0) && !__ODD(OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 350470)]->sysflag)) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__IMPORT(", 10);
      _ptr__79 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 350003)]->name;
      OfrontOPM_WriteString((void*)_ptr__79->data, _ptr__79->len[0]);
...
void OfrontOPC_EnterBody (void)
{
  ...
  OfrontOPC_EndStat();
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPC", 369663) != 0) {
...
{
  OfrontOPM_WriteLn();
  OfrontOPM_WriteString((CHAR*)"__CLOSE void ", 14);
  OfrontOPM_WriteString((void*)OfrontOPM_modName, 32);
...
void OfrontOPC_EnterProc (OfrontOPT_Object proc)
{
  ...
  OfrontOPS_String _ptr__47 = NIL;
  OfrontOPS_String _ptr__46 = NIL;
  ...
  if (!scope->leaf) {
    ...
    OfrontOPM_WriteString((CHAR*)" = ", 4);
    _ptr__47 = scope->name;
    OfrontOPM_WriteString((void*)_ptr__47->data, _ptr__47->len[0]);
    OfrontOPM_WriteString((CHAR*)"_s", 3);
    OfrontOPC_EndStat();
    OfrontOPC_BegStat();
    _ptr__46 = scope->name;
    OfrontOPM_WriteString((void*)_ptr__46->data, _ptr__46->len[0]);
    OfrontOPM_WriteString((CHAR*)"_s", 3);
    OfrontOPM_WriteString((CHAR*)" = ", 4);
    OfrontOPM_Write('&');
    OfrontOPM_WriteString((CHAR*)"_s", 3);
...
{
  OfrontOPS_String _ptr__107 = NIL;
  __ASSERT((INTEGER)ap->typ->comp == 4, 0, (CHAR*)"OfrontOPC", 429086);
  if ((INTEGER)ap->mode == 2) {
    if ((INTEGER)ap->mnolev != OfrontOPM_level) {
      _ptr__107 = ap->scope->name;
      OfrontOPM_WriteString((void*)_ptr__107->data, _ptr__107->len[0]);
...
void OfrontOPC_Cmp (SHORTINT rel)
{
  switch (rel) {
    ...
    case 16: 
      OfrontOPM_WriteString((CHAR*)" >= ", 5);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 436252);
  }
}
...
static void OfrontOPC_WriteCharLiteral (LONGCHAR ch, BOOLEAN wide)
{
  if (ch >= ' ' && ch <= '~') {
    ...
    __ASSERT(ch <= 0xff, 0, (CHAR*)"OfrontOPC", 439573);
    OfrontOPM_WriteString((CHAR*)"0x", 3);
...
static void OfrontOPC_WriteStringLiteral (CHAR *str, INTEGER str__len, INTEGER len)
{
  ...
  i = 0;
  while (i < len) {
    ch = str[__X(i, str__len, (CHAR*)"OfrontOPC", 441887)];
    if (ch >= ' ' && ch <= '~') {
      if (((ch == '\\' || ch == '\?') || ch == '\'') || ch == '\"') {
        OfrontOPM_Write('\\');
      }
      ...
      if (i + 1 < len) {
        switch (str[__X(i + 1, str__len, (CHAR*)"OfrontOPC", 443924)]) {
...
void OfrontOPC_Case (INTEGER caseVal, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 1: case 14: case 4: case 5: case 6: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 448767);
  }
  OfrontOPM_WriteString((CHAR*)": ", 3);
}
...
void OfrontOPC_Constant (OfrontOPT_Const con, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 11: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 468735);
  }
}

/*----------------------------------------------------------------------------*/
static struct InitKeywords__80 {
  SHORTINT *n;
  struct InitKeywords__80 *lnk;
} *InitKeywords__80_s;

static void __81 (CHAR *s, INTEGER s__len);

static void __81 (CHAR *s, INTEGER s__len)
{
  SHORTINT h;
  h = OfrontOPC_PerfectHash((void*)s, s__len);
  OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 471084)] = (*InitKeywords__80_s->n);
  __STRCOPYCC(s, OfrontOPC_keytab[__X((*InitKeywords__80_s->n), 37, (CHAR*)"OfrontOPC", 471101)], __MIN(9, s__len), (CHAR*)"OfrontOPC", 471101);
  (*InitKeywords__80_s->n) += 1;
}

static void OfrontOPC_InitKeywords (void)
{
  SHORTINT n, i;
  struct InitKeywords__80 _s;
  _s.n = &n;
  _s.lnk = InitKeywords__80_s;
  InitKeywords__80_s = &_s;
  n = 0;
  i = 0;
  while ((INTEGER)i <= 168) {
    OfrontOPC_hashtab[__X(i, 169, (CHAR*)"OfrontOPC", 472116)] = -1;
    i += 1;
  }
  __81((CHAR*)"asm", 4);
  __81((CHAR*)"auto", 5);
  ...
  __81((CHAR*)"typedef", 8);
  __81((CHAR*)"union", 6);
  __81((CHAR*)"unsigned", 9);
  __81((CHAR*)"void", 5);
  __81((CHAR*)"volatile", 9);
  __81((CHAR*)"while", 6);
  InitKeywords__80_s = _s.lnk;
}
