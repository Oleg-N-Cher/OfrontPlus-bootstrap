...
static void OfrontOPM_ScanOptions (CHAR *s, INTEGER s__len, SET *opt)
{
  INTEGER i;
  i = 1;
  while (s[__X(i, s__len, (CHAR*)"OfrontOPM", 75537)] != 0x00) {
    switch (s[__X(i, s__len, (CHAR*)"OfrontOPM", 75788)]) {
      case 'e': 
        *opt = *opt ^ 0x0200;
        break;
      case 's': 
      ...
      case '1': case '3': case 'C': case '7': 
        OfrontOPM_Lang = s[__X(i, s__len, (CHAR*)"OfrontOPM", 80127)];
        break;
      case 'G': 
        *opt = *opt ^ 0x010000;
        break;
      case 'O': 
        *opt = *opt ^ 0x020000;
        break;
      case '2': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 83455)] == '1') {
          OfrontOPM_AdrSize = 2;
          OfrontOPM_Alignment = 1;
          i += 1;
        } else if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 82687)] == '2') {
          OfrontOPM_AdrSize = 2;
        ...
        break;
      case '4': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 85503)] == '4') {
          OfrontOPM_AdrSize = 4;
          OfrontOPM_Alignment = 4;
          i += 1;
        } else if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 83967)] == '8') {
          OfrontOPM_AdrSize = 4;
          ...
          OfrontOPM_LogW('-');
          OfrontOPM_LogW('4');
          if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 84785)] != 0x00) {
            OfrontOPM_LogW(s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 84773)]);
            i += 1;
          }
        ...
        break;
      case '8': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 87295)] == '8') {
          OfrontOPM_AdrSize = 8;
          OfrontOPM_Alignment = 8;
          i += 1;
        } else {
          ...
          OfrontOPM_LogW('-');
          OfrontOPM_LogW('8');
          if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 86577)] != 0x00) {
            OfrontOPM_LogW(s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 86565)]);
            i += 1;
          }
          OfrontOPM_LogWStr((CHAR*)" ignored", 9);
          OfrontOPM_LogWLn();
      ...
      default: 
        OfrontOPM_LogWStr((CHAR*)"  warning: option ", 19);
        OfrontOPM_LogW('-');
        OfrontOPM_LogW(s[__X(i, s__len, (CHAR*)"OfrontOPM", 87363)]);
        OfrontOPM_LogWStr((CHAR*)" ignored", 9);
        OfrontOPM_LogWLn();
        break;
    }
...
void OfrontOPM_Init (CHAR *msg, INTEGER msg__len, BOOLEAN *done)
{
  ...
  *done = 0;
  ...
  s[0] = 0x00;
  CmdArgs_Get(OfrontOPM_S, (void*)s, 256);
  endpos = __STRLEN(s, 256, (CHAR*)"OfrontOPM", 104471) - 4;
...
static void OfrontOPM_MakeFileName (CHAR *name, INTEGER name__len, CHAR *FName, INTEGER FName__len, CHAR *ext, INTEGER ext__len)
{
  ...
  i = 0;
  for (;;) {
    ch = name[__X(i, name__len, (CHAR*)"OfrontOPM", 117012)];
    if (ch == 0x00) {
      break;
    }
    FName[__X(i, FName__len, (CHAR*)"OfrontOPM", 117521)] = ch;
    i += 1;
  }
  j = 0;
  do {
    ch = ext[__X(j, ext__len, (CHAR*)"OfrontOPM", 118293)];
    FName[__X(i, FName__len, (CHAR*)"OfrontOPM", 118309)] = ch;
    i += 1;
    j += 1;
  } while (!(ch == 0x00));
}
...
static void OfrontOPM_InitCrcTab (void)
{
  ...
  while (x < 256) {
    ...
    OfrontOPM_crc32tab[__X((INTEGER)((SET)x ^ 0xff), 256, (CHAR*)"OfrontOPM", 135745)] = (INTEGER)((SET)c ^ 0xff);
    x += 1;
  }
}
...
{
  INTEGER c;
  c = (INTEGER)((SET)__ASHL(*fp, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(*fp, 24, INTEGER) ^ (SET)__ASHR(val, 24, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 138088)]);
  c = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)__ASHR(val, 16, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 138340)]);
  c = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)__ASHR(val, 8, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 138594)]);
  *fp = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)val), -256), 256, (CHAR*)"OfrontOPM", 139007)]);
}
...
{
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPM", 169983) != 0 || __IN(10, OfrontOPM_opt)) {
...
void OfrontOPM_Write (CHAR ch)
{
  if (OfrontOPM_currFile != -1) {
    Files_WriteChar(&OfrontOPM_R[__X(OfrontOPM_currFile, 3, (CHAR*)"OfrontOPM", 174655)], Files_Rider__typ, ch);
  }
}
...
void OfrontOPM_WriteString (CHAR *s, INTEGER s__len)
{
  INTEGER i;
  if (OfrontOPM_currFile != -1) {
    i = __STRLEN(s, s__len, (CHAR*)"OfrontOPM", 176399);
    Files_WriteBytes(&OfrontOPM_R[__X(OfrontOPM_currFile, 3, (CHAR*)"OfrontOPM", 176895)], Files_Rider__typ, (void*)(SYSTEM_ADRINT)s, i, i);
  }
}
...
void OfrontOPM_WriteInt (LONGINT i)
{
  ...
  if (i == (-2147483647-1) || i == (-9223372036854775807LL-1)) {
    ...
    k = 1;
    while (i1 > 0) {
      s[__X(k, 20, (CHAR*)"OfrontOPM", 184379)] = (CHAR)(__MOD(i1, 10) + 48);
      i1 = __DIV(i1, 10);
      k += 1;
    }
    if (i < 0) {
      s[__X(k, 20, (CHAR*)"OfrontOPM", 184604)] = '-';
      k += 1;
    }
    while (k > 0) {
      k -= 1;
      OfrontOPM_Write(s[__X(k, 20, (CHAR*)"OfrontOPM", 184870)]);
    }
...
void OfrontOPM_WriteReal (REAL r, CHAR suffx)
{
  ...
  if ((r < 9223372036854775600.0 && r > -9223372036854775600.0) && r == (REAL)(__ENTIERL(r))) {
    ...
    while (ch != 0x00) {
      s[__X(i, 32, (CHAR*)"OfrontOPM", 189214)] = ch;
      i += 1;
      Texts_Read(&R, Texts_Reader__typ, &ch);
    }
    s[__X(i, 32, (CHAR*)"OfrontOPM", 189965)] = 0x00;
    i = 0;
    ch = s[0];
    while (ch != 'E' && ch != 0x00) {
      i += 1;
      ch = s[__X(i, 32, (CHAR*)"OfrontOPM", 190517)];
    }
    if (ch == 'E') {
      s[__X(i, 32, (CHAR*)"OfrontOPM", 190751)] = 'e';
    }
...
void OfrontOPM_OpenFiles (CHAR *moduleName, INTEGER moduleName__len)
{
  ...
  __STRCOPYCC(moduleName, OfrontOPM_modName, __MIN(32, moduleName__len), (CHAR*)"OfrontOPM", 199960);
...
void OfrontOPM_CloseFiles (void)
{
  ...
  if (OfrontOPM_noerr) {
    if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPM", 211967) == 0) {
