...
{
  __ASSERT(y != 0, 0, (CHAR*)"OfrontOPM", 34063);
...
{
  __ASSERT(y != 0, 0, (CHAR*)"OfrontOPM", 35343);
  return x / y;
}
...
{
  __ASSERT(y != 0, 0, (CHAR*)"OfrontOPM", 36623);
  return x % y;
}
...
{
  __ASSERT(0 <= n && n <= 63, 0, (CHAR*)"OfrontOPM", 37918);
...
{
  __ASSERT(0 <= n && n <= 63, 0, (CHAR*)"OfrontOPM", 39454);
  return __LSH(x, -n, LONGINT);
}
...
{
  __ASSERT(0 <= n && n <= 63, 0, (CHAR*)"OfrontOPM", 40990);
...
static void OfrontOPM_ChkSum (INTEGER *fp, INTEGER val)
{
  *fp = (INTEGER)((SET)__ASHL(*fp, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(*fp, 24, INTEGER) ^ (SET)val), -256), 256, (CHAR*)"OfrontOPM", 46591)]);
}
...
{
  __ASSERT(val >= 0 && val < 65536, 0, (CHAR*)"OfrontOPM", 56100);
  if (val < 128) {
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 56606)] = (CHAR)val;
    *idx += 1;
  } else if (val < 2048) {
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 57131)] = (CHAR)(__ASHR(val, 6, INTEGER) + 192);
    *idx += 1;
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 57387)] = (CHAR)(__MASK(val, -64) + 128);
    *idx += 1;
  } else {
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 57901)] = (CHAR)(__ASHR(val, 12, INTEGER) + 224);
    *idx += 1;
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 58162)] = (CHAR)(__MASK(__ASHR(val, 6, INTEGER), -64) + 128);
    *idx += 1;
    str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 58411)] = (CHAR)(__MASK(val, -64) + 128);
    *idx += 1;
  }
}
...
{
  CHAR ch;
  ch = str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 60176)];
  *idx += 1;
  if (ch < 0x80) {
    *val = (SHORTINT)ch;
  } else if (ch < 0xe0) {
    *val = (INTEGER)ch - 192;
    ch = str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 61457)];
    *idx += 1;
    *val = (__ASHL(*val, 6, INTEGER) + (INTEGER)ch) - 128;
  } else {
    *val = (INTEGER)ch - 224;
    ch = str[__X(*idx, str__len, (CHAR*)"OfrontOPM", 62225)];
    *idx += 1;
    *val = (__ASHL(*val, 6, INTEGER) + (INTEGER)ch) - 128;
...
static void OfrontOPM_ScanOptions (CHAR *s, INTEGER s__len, SET *opt)
{
  INTEGER i;
  i = 1;
  while (s[__X(i, s__len, (CHAR*)"OfrontOPM", 75281)] != 0x00) {
    switch (s[__X(i, s__len, (CHAR*)"OfrontOPM", 75532)]) {
      case 'e': 
        *opt = *opt ^ 0x0200;
        break;
      case 's': 
      ...
      case '1': case '3': case 'C': case '7': 
        OfrontOPM_Lang = s[__X(i, s__len, (CHAR*)"OfrontOPM", 79871)];
        break;
      case 'G': 
        *opt = *opt ^ 0x010000;
        break;
      case 'O': 
        *opt = *opt ^ 0x020000;
        break;
      case '2': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 83199)] == '1') {
          OfrontOPM_AdrSize = 2;
          OfrontOPM_Alignment = 1;
          i += 1;
        } else if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 82431)] == '2') {
          OfrontOPM_AdrSize = 2;
        ...
        break;
      case '4': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 85247)] == '4') {
          OfrontOPM_AdrSize = 4;
          OfrontOPM_Alignment = 4;
          i += 1;
        } else if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 83711)] == '8') {
          OfrontOPM_AdrSize = 4;
          ...
          OfrontOPM_LogW('-');
          OfrontOPM_LogW('4');
          if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 84529)] != 0x00) {
            OfrontOPM_LogW(s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 84517)]);
            i += 1;
          }
        ...
        break;
      case '8': 
        if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 87039)] == '8') {
          OfrontOPM_AdrSize = 8;
          OfrontOPM_Alignment = 8;
          i += 1;
        } else {
          ...
          OfrontOPM_LogW('-');
          OfrontOPM_LogW('8');
          if (s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 86321)] != 0x00) {
            OfrontOPM_LogW(s[__X(i + 1, s__len, (CHAR*)"OfrontOPM", 86309)]);
            i += 1;
          }
          OfrontOPM_LogWStr((CHAR*)" ignored", 9);
          OfrontOPM_LogWLn();
      ...
      default: 
        OfrontOPM_LogWStr((CHAR*)"  warning: option ", 19);
        OfrontOPM_LogW('-');
        OfrontOPM_LogW(s[__X(i, s__len, (CHAR*)"OfrontOPM", 87107)]);
        OfrontOPM_LogWStr((CHAR*)" ignored", 9);
        OfrontOPM_LogWLn();
        break;
    }
  ...
  if ((0x0c00 & *opt) == 0x0c00) {
    *opt &= ~__SETOF(10);
    OfrontOPM_LogWStr((CHAR*)"  warning: option ", 19);
    OfrontOPM_LogW('-');
    OfrontOPM_LogWStr((CHAR*)"m ignored", 10);
    OfrontOPM_LogWLn();
  }
}
...
void OfrontOPM_OpenPar (CHAR *title, INTEGER title__len, CHAR *cmd, INTEGER cmd__len)
{
  ...
  if (CmdArgs_Count == 0) {
    ...
    Console_Ln();
    Console_String((CHAR*)"Copyright (c) Software Templ OG, 1995-2020 & VEDAsoft Oberon Club, 2013-2024", 77);
    Console_Ln();
    Console_Ln();
    ...
    Console_Ln();
    Console_String((CHAR*)"       \"w\": UCS-2 encoded wide character format enabled             (off)", 74);
    Console_Ln();
...
void OfrontOPM_Init (CHAR *msg, INTEGER msg__len, BOOLEAN *done)
{
  ...
  *done = 0;
  ...
  s[0] = 0x00;
  CmdArgs_Get(OfrontOPM_S, (void*)s, 256);
  endpos = __STRLEN(s, 256, (CHAR*)"OfrontOPM", 104215) - 4;
...
static void OfrontOPM_MakeFileName (CHAR *name, INTEGER name__len, CHAR *FName, INTEGER FName__len, CHAR *ext, INTEGER ext__len)
{
  ...
  i = 0;
  for (;;) {
    ch = name[__X(i, name__len, (CHAR*)"OfrontOPM", 116756)];
    if (ch == 0x00) {
      break;
    }
    FName[__X(i, FName__len, (CHAR*)"OfrontOPM", 117265)] = ch;
    i += 1;
  }
  j = 0;
  do {
    ch = ext[__X(j, ext__len, (CHAR*)"OfrontOPM", 118037)];
    FName[__X(i, FName__len, (CHAR*)"OfrontOPM", 118053)] = ch;
    i += 1;
    j += 1;
  } while (!(ch == 0x00));
}
...
static void OfrontOPM_InitCrcTab (void)
{
  ...
  while (x < 256) {
    ...
    OfrontOPM_crc32tab[__X((INTEGER)((SET)x ^ 0xff), 256, (CHAR*)"OfrontOPM", 135489)] = (INTEGER)((SET)c ^ 0xff);
    x += 1;
  }
}
...
{
  INTEGER c;
  c = (INTEGER)((SET)__ASHL(*fp, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(*fp, 24, INTEGER) ^ (SET)__ASHR(val, 24, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 137832)]);
  c = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)__ASHR(val, 16, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 138084)]);
  c = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)__ASHR(val, 8, INTEGER)), -256), 256, (CHAR*)"OfrontOPM", 138338)]);
  *fp = (INTEGER)((SET)__ASHL(c, 8, INTEGER) ^ (SET)OfrontOPM_crc32tab[__X(__MASK((INTEGER)((SET)__ASHR(c, 24, INTEGER) ^ (SET)val), -256), 256, (CHAR*)"OfrontOPM", 138751)]);
}
...
LONGINT OfrontOPM_SymRInt (void)
{
  ...
  while ((INTEGER)b < 0) {
    n += __ASH((INTEGER)b + 128, s, INTEGER);
    s += 7;
    Files_ReadByte(&OfrontOPM_oldSF, Files_Rider__typ, &b);
    OfrontOPM_ChkSum(&OfrontOPM_checksum, b);
  }
  n += __ASH(__MASK((INTEGER)b + 64, -128) - 64, s, INTEGER);
  return n;
}
...
{
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPM", 169727) != 0 || __IN(10, OfrontOPM_opt)) {
...
void OfrontOPM_Write (CHAR ch)
{
  if (OfrontOPM_currFile != -1) {
    Files_WriteChar(&OfrontOPM_R[__X(OfrontOPM_currFile, 3, (CHAR*)"OfrontOPM", 174399)], Files_Rider__typ, ch);
  }
}
...
void OfrontOPM_WriteString (CHAR *s, INTEGER s__len)
{
  INTEGER i;
  if (OfrontOPM_currFile != -1) {
    i = __STRLEN(s, s__len, (CHAR*)"OfrontOPM", 176143);
    Files_WriteBytes(&OfrontOPM_R[__X(OfrontOPM_currFile, 3, (CHAR*)"OfrontOPM", 176639)], Files_Rider__typ, (void*)(SYSTEM_ADRINT)s, i, i);
  }
}
...
void OfrontOPM_WriteInt (LONGINT i)
{
  ...
  if (i == (-2147483647-1) || i == (-9223372036854775807LL-1)) {
    ...
    k = 1;
    while (i1 > 0) {
      s[__X(k, 20, (CHAR*)"OfrontOPM", 184123)] = (CHAR)(__MOD(i1, 10) + 48);
      i1 = __DIV(i1, 10);
      k += 1;
    }
    if (i < 0) {
      s[__X(k, 20, (CHAR*)"OfrontOPM", 184348)] = '-';
      k += 1;
    }
    while (k > 0) {
      k -= 1;
      OfrontOPM_Write(s[__X(k, 20, (CHAR*)"OfrontOPM", 184614)]);
    }
...
void OfrontOPM_WriteReal (REAL r, CHAR suffx)
{
  ...
  if ((r < 9223372036854775600.0 && r > -9223372036854775600.0) && r == (REAL)(__ENTIERL(r))) {
    ...
    while (ch != 0x00) {
      s[__X(i, 32, (CHAR*)"OfrontOPM", 188958)] = ch;
      i += 1;
      Texts_Read(&R, Texts_Reader__typ, &ch);
    }
    s[__X(i, 32, (CHAR*)"OfrontOPM", 189709)] = 0x00;
    i = 0;
    ch = s[0];
    while (ch != 'E' && ch != 0x00) {
      i += 1;
      ch = s[__X(i, 32, (CHAR*)"OfrontOPM", 190261)];
    }
    if (ch == 'E') {
      s[__X(i, 32, (CHAR*)"OfrontOPM", 190495)] = 'e';
    }
...
void OfrontOPM_OpenFiles (CHAR *moduleName, INTEGER moduleName__len)
{
  ...
  __STRCOPYCC(moduleName, OfrontOPM_modName, __MIN(32, moduleName__len), (CHAR*)"OfrontOPM", 199704);
...
void OfrontOPM_CloseFiles (void)
{
  ...
  if (OfrontOPM_noerr) {
    if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPM", 211711) == 0) {
...
{
  __ENUMR(&OfrontOPM_inR, Texts_Reader__typ, 52, 1, P);
  P(OfrontOPM_Log);
  __ENUMR(&OfrontOPM_W, Texts_Writer__typ, 40, 1, P);
