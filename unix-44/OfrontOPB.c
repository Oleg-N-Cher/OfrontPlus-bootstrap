  ...
  if (__IN(typ->form, 0x407e)) {
    ...
    switch (typ->size) {
      ...
      case 4: 
        ...
        break;
      case 8: 
        y->val8 = __NEWARR(NIL, 8, 4, 1, 1, (SYSTEM_ARRLEN)n);
        break;
...
static void OfrontOPB_Promote (OfrontOPT_Node *left, OfrontOPT_Node *right, INTEGER op)
{
  ...
  if (OfrontOPM_Lang != '3' && __IN(f, 0x41f2)) {
    if (__IN(g, 0x41f2)) {
      if ((((f == 7 && (INTEGER)(*right)->class == 7) && __IN(g, 0x0180)) && (INTEGER)(*left)->class != 7) || (((g == 7 && (INTEGER)(*left)->class == 7) && __IN(f, 0x0180)) && (INTEGER)(*right)->class != 7)) {
...
void OfrontOPB_CheckParameters (OfrontOPT_Object fp, OfrontOPT_Object ap, BOOLEAN checkNames)
{
  ...
  while (fp != NIL) {
    if (ap != NIL) {
      ...
      if ((((!OfrontOPT_EqualType(ft, at) || (INTEGER)fp->mode != (INTEGER)ap->mode) || (INTEGER)fp->sysflag != (INTEGER)ap->sysflag) || (INTEGER)fp->vis != (INTEGER)ap->vis) || (checkNames && __STRCMPCC(fp->name->data, ap->name->data, ap->name->len[0], (CHAR*)"OfrontOPB", 190270) != 0)) {
        OfrontOPB_err(115);
      }
      ap = ap->link;
    } else {
...
static SHORTINT __20 (void)
{
  ...
  switch ((*ConstOp__19_s->f)) {
    ...
    case 9: 
      ...
      break;
    case 10: case 18: 
      if (__STRCMPCC(((*ConstOp__19_s->xval))->ext->data, ((*ConstOp__19_s->yval))->ext->data, ((*ConstOp__19_s->yval))->ext->len[0], (CHAR*)"OfrontOPB", 204799) < 0) {
        res = 13;
      } else if (__STRCMPCC(((*ConstOp__19_s->xval))->ext->data, ((*ConstOp__19_s->yval))->ext->data, ((*ConstOp__19_s->yval))->ext->len[0], (CHAR*)"OfrontOPB", 204031) > 0) {
        res = 15;
      } else {
        res = 11;
      }
    ...
    case 11: case 13: case 15: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPB", 205567);
  }
  ...
  switch (op) {
    ...
    case 8: 
      if (__IN(f, 0x4072)) {
        ...
        i = 0;
        while ((xval->ext->data)[__X(i, xval->ext->len[0], (CHAR*)"OfrontOPB", 246819)] != 0x00) {
          (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPB", 246844)] = (xval->ext->data)[__X(i, xval->ext->len[0], (CHAR*)"OfrontOPB", 246844)];
          i += 1;
        }
        j = 0;
        while ((yval->ext->data)[__X(j, yval->ext->len[0], (CHAR*)"OfrontOPB", 247075)] != 0x00) {
          (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPB", 247100)] = (yval->ext->data)[__X(j, yval->ext->len[0], (CHAR*)"OfrontOPB", 247100)];
          i += 1;
          j += 1;
        }
        (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPB", 247313)] = 0x00;
        xval->ext = ext;
    ...
    case 16: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPB", 261631);
  }
    ...
    if ((INTEGER)z->class == 7 && (INTEGER)y->class == 7) {
      ...
      switch (op) {
        ...
        case 16: 
          ...
          __54(op, typ, &z, y);
          break;
        default: __CASECHK((CHAR*)"OfrontOPB", 335359);
      }
    }
  }
  *x = z;
...
void OfrontOPB_CheckAssign (OfrontOPT_Struct x, OfrontOPT_Node *ynode)
{
  ...
  switch (f) {
    ...
    case 16: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPB", 376063);
  }
...
static void OfrontOPB_AssignString (OfrontOPT_Node *x, OfrontOPT_Node str)
{
  __ASSERT((INTEGER)str->class == 7 && __IN(str->typ->form, 0x040400), 0, (CHAR*)"OfrontOPB", 378438);
  ...
  switch (fctno) {
    ...
    case 23: 
      if ((INTEGER)x->class == 9) {
        ...
        if ((INTEGER)x->class == 7 && (INTEGER)x->typ->form == 3) {
          OfrontOPB_CharToString8(x);
        } else if ((INTEGER)x->class == 7 && (INTEGER)x->typ->form == 17) {
          OfrontOPB_CharToString16(x);
        }
        if (!__IN(x->typ->comp, 0x0c) && !__IN(x->typ->form, 0x040400)) {
          OfrontOPB_err(131);
        }
      }
      break;
    ...
    case 32: case 33: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPB", 450303);
  }
  *par0 = x;
}
      ...
      if (((INTEGER)fctno == 19 || (INTEGER)fctno == 20) && (INTEGER)parno == 1) {
        ...
        if (__IN(p->typ->form, 0x040400)) {
          if ((INTEGER)p->class == 7) {
            ...
            if (OfrontOPM_noerr) {
              __ASSERT((INTEGER)p->class == 3, 0, (CHAR*)"OfrontOPB", 536114);
            }
            switch (OfrontOPM_IndexSize) {
              case 2: 
...
static BOOLEAN OfrontOPB_Overlap (OfrontOPT_Node left, OfrontOPT_Node right)
{
  ...
  __RETCHK((CHAR*)"OfrontOPB", 596223);
}
    ...
    *length = OfrontOPB_NewIntConst(n->conval->intval2 - 1);
    ...
    if ((INTEGER)n->typ->comp == 2) {
      *length = OfrontOPB_NewIntConst(n->typ->n - 1);
      ...
      __ASSERT(((INTEGER)n->class == 3 || (INTEGER)n->class == 0) || (INTEGER)n->class == 1, 0, (CHAR*)"OfrontOPB", 607561);
