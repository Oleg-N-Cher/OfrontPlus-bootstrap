...
export INTEGER Platform_OSAllocate (INTEGER size);
export void Platform_OSFree (INTEGER address);
...
export INTEGER Platform_Read (INTEGER h, INTEGER p, INTEGER l, INTEGER *n);
...
export INTEGER Platform_Write (INTEGER h, INTEGER p, INTEGER l);
...
static BOOLEAN Platform_getEnv (CHAR *var, INTEGER var__len, CHAR *val, INTEGER val__len);
...
/*----------------------------------------------------------------------------*/
INTEGER Platform_OSAllocate (INTEGER size)
{
  if (size > 0) {
...
/*----------------------------------------------------------------------------*/
void Platform_OSFree (INTEGER address)
{
...
{
  if (!Platform_getEnv((void*)var, var__len, (void*)val, val__len)) {
    val[0] = 0x00;
  }
}
...
void Platform_GetTempPath (CHAR *path, INTEGER path__len)
{
  ...
  if (i != 0 && i < path__len) {
    __STRCOPYCC(s, path, __MIN(path__len, 1024), (CHAR*)"Platform", 93230);
  } else {
    __STRCOPYCC((CHAR*)"/tmp/", path, path__len, (CHAR*)"Platform", 93251);
  }
}

/*----------------------------------------------------------------------------*/
INTEGER Platform_Read (INTEGER h, INTEGER p, INTEGER l, INTEGER *n)
{
...
/*----------------------------------------------------------------------------*/
INTEGER Platform_Write (INTEGER h, INTEGER p, INTEGER l)
{
  INTEGER written;
...
INTEGER Platform_ChDir (CHAR *n, INTEGER n__len)
{
  ...
  __RETCHK((CHAR*)"Platform", 121898);
}

/*----------------------------------------------------------------------------*/
void Platform_GetAppDir (CHAR *dir, INTEGER dir__len)
{
  __STRCOPYCC((CHAR*)"./", dir, dir__len, (CHAR*)"Platform", 123647);
}

/*----------------------------------------------------------------------------*/
void Platform_GetAppDirW (LONGCHAR *dir, INTEGER dir__len)
{
  __STRCOPYLL(((LONGCHAR[]){46, 47, 0}), dir, dir__len, (CHAR*)"Platform", 125183);
}
