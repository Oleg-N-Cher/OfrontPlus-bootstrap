...
{
  __ENUMR(&arStream_out, arText_StreamWriter__typ, 40, 1, P);
  __ENUMR(&arStream_err, arText_StreamWriter__typ, 40, 1, P);
}

__TDESC(arStream_Stream__desc, 4, 0) = {__TDFLDS("Stream", 8), {-8}};
__TDESC(arStream_File__desc, 15, 1) = {__TDFLDS("File", 40), {32, -16}};
