...
static INTEGER NetHttp_Length (LONGINT s);
static LONGINT NetHttp_write_callback (LONGINT ptr, LONGINT size, LONGINT nmemb, LONGINT userdata);
...
/*----------------------------------------------------------------------------*/
__TDESC(NetHttp_Socket__desc, 2, 1) = {__TDFLDS("Socket", 160), {144, -16}};
...
export void *NetHttp__init (void)
{
  ...
  __INITBP(NetHttp_Socket, NetHttp_Socket_Get, 0);
/* BEGIN */
  __ENDMOD;
}
