...
Heap_Module Modules_ThisMod (CHAR *name, INTEGER name__len)
{
  ...
  if (m != NIL) {
    ...
    Modules_res = 1;
    __STRCOPYCC(name, Modules_importing, __MIN(32, name__len), (CHAR*)"Modules", 7717);
...
Heap_Command Modules_ThisCommand (Heap_Module mod, CHAR *name, INTEGER name__len)
{
  ...
  if (c != NIL) {
    ...
    Modules_res = 2;
    __STRCOPYCC(name, Modules_importing, __MIN(32, name__len), (CHAR*)"Modules", 10533);
    __STRCOPYCC((CHAR*)" command \"", _str__3, 256, (CHAR*)"Modules", 10820);
    __STRAPNDCC(mod->name, 32, _str__3, 256, (CHAR*)"Modules", 10820);
