...
{
  __ENUMR(&BrowserCmd_W, Texts_Writer__typ, 64, 1, P);
}

__TDESC(BrowserCmd__1__desc, 1, 0) = {__TDFLDS("", 8), {-8}};
...
/* BEGIN */
  ...
  if (CmdArgs_Count != 0) {
    ...
    Console_Ln();
    Console_String((CHAR*)"Copyright (c) Software Templ OG, 1995-2020 & VEDAsoft Oberon Club, 2013-2020", 77);
    Console_Ln();
    Console_Ln();
    ...
    Console_Ln();
    Console_Ln();
    Console_String((CHAR*)"       \"1\": Oberon", 19);
    Console_Ln();
    Console_String((CHAR*)"       \"2\": Oberon-2", 21);
    Console_Ln();
    Console_String((CHAR*)"       \"7\": Oberon-07", 22);
    Console_Ln();
