...
export void Kernel_Assert (INTEGER code, LONGINT mod, INTEGER pos);
static void Kernel_DisplayHaltCode (INTEGER code);
export void Kernel_Exit (INTEGER code);
export void Kernel_Halt (INTEGER code, LONGINT mod, INTEGER pos);
static void Kernel_OutModName (LONGINT s, INTEGER pos);
...
void Kernel_Halt (INTEGER code, LONGINT mod, INTEGER pos)
{
  Heap_FINALL();
...
/*----------------------------------------------------------------------------*/
void Kernel_Assert (INTEGER code, LONGINT mod, INTEGER pos)
{
  Heap_FINALL();
  Kernel_OutModName(mod, pos);
