...
static arStringList_Array arConfiguration_CopyArgVec (arArgs_ArgVec p)
{
  ...
  result = __NEWARR(POINTER__typ, 8, 8, 1, 1, (SYSTEM_ARRLEN)len);
  _for__17 = len - 1;
  i = 0;
  while (i <= _for__17) {
    strLen = 0;
...
__TDESC(arConfiguration_ValueDesc__desc, 5, 4) = {__TDFLDS("ValueDesc", 32), {0, 8, 16, 24, -40}};
__TDESC(arConfiguration_Boolean__rec__desc, 5, 4) = {__TDFLDS("Boolean__rec", 40), {0, 8, 16, 24, -40}};
__TDESC(arConfiguration_Integer__rec__desc, 5, 4) = {__TDFLDS("Integer__rec", 40), {0, 8, 16, 24, -40}};
__TDESC(arConfiguration_String__rec__desc, 5, 5) = {__TDFLDS("String__rec", 40), {0, 8, 16, 24, 32, -48}};
__TDESC(arConfiguration_Procedure__rec__desc, 5, 4) = {__TDFLDS("Procedure__rec", 40), {0, 8, 16, 24, -40}};
__TDESC(arConfiguration_Assoc__rec__desc, 5, 5) = {__TDFLDS("Assoc__rec", 48), {0, 8, 16, 24, 32, -48}};
