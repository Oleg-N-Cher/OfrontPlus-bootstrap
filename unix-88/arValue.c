...
BOOLEAN arValue_List_Equals (arValue_List self, arValue_Object other)
{
  ...
  if (__ISP(other, arValue_List__rec, 1)) {
    ...
    __ASSERT(a == b, -1, (CHAR*)"arValue", 143375);
    return 1;
  } else {
    return 0;
  }
...
arValue_IntArray arValue_List_ToIntArray (arValue_List self)
{
  ...
  __ASSERT(i == count, -1, (CHAR*)"arValue", 171794);
  return result;
}
...
arValue_StringArray arValue_List_ToStringArray (arValue_List self)
{
  ...
  __ASSERT(i == count, -1, (CHAR*)"arValue", 178962);
  return result;
}
...
arValue_ObjectArray arValue_List_ToObjectArray (arValue_List self)
{
  ...
  __ASSERT(i == self->length, -1, (CHAR*)"arValue", 183576);
  return result;
}
...
{
  arValue_ListElement it = NIL;
  __ASSERT(index >= 0 && index < self->length, -1, (CHAR*)"arValue", 187693);
  it = self->first;
  while (index > 0) {
    it = it->next;
    index -= 1;
...
{
  arValue_ListElement it = NIL;
  __ASSERT(index >= 0 && index < self->length, -1, (CHAR*)"arValue", 190509);
  it = self->first;
  while (index > 0) {
    it = it->next;
    index -= 1;
...
{
  __ASSERT(index >= 0 && index < self->length, -1, (CHAR*)"arValue", 266029);
...
{
  __ASSERT(index >= 0 && index < self->length, -1, (CHAR*)"arValue", 267565);
