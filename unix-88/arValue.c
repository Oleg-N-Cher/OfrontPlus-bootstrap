...
arValue_String arValue_String_Extract (arValue_String self, INTEGER start, INTEGER count)
{
  ...
  i = 0;
  while (i <= _for__18) {
    (result->data)[__X(i, result->len[0], (CHAR*)"arValue", 86015)] = (self->value->data)[__X(i + start, self->value->len[0], (CHAR*)"arValue", 86015)];
    i += 1;
  }
  (result->data)[__X(count, result->len[0], (CHAR*)"arValue", 86292)] = 0x00;
...
BOOLEAN arValue_String_EndsWith (arValue_String self, CHAR *value, INTEGER value__len)
{
  ...
  i = 0;
  while (i <= _for__13) {
    if (value[__X(i, value__len, (CHAR*)"arValue", 90182)] != (self->value->data)[__X((self->length - length) + i, self->value->len[0], (CHAR*)"arValue", 90182)]) {
      return 0;
    }
    i += 1;
  }
...
BOOLEAN arValue_String_StartsWith (arValue_String self, CHAR *value, INTEGER value__len)
{
  ...
  i = 0;
  while (i <= _for__41) {
    if (value[__X(i, value__len, (CHAR*)"arValue", 92979)] != (self->value->data)[__X(i, self->value->len[0], (CHAR*)"arValue", 92979)]) {
      return 0;
    }
    i += 1;
  }
...
{
  if (__STRCMPCC(value, (CHAR*)"true", 5, (CHAR*)"arValue", 97796) == 0) {
    return arValue_NewBoolean(1);
  } else if (__STRCMPCC(value, (CHAR*)"false", 6, (CHAR*)"arValue", 97049) == 0) {
...
BOOLEAN arValue_List_Equals (arValue_List self, arValue_Object other)
{
  ...
  if (__ISP(other, arValue_List__rec, 1)) {
    ...
    __ASSERT(a == b, 0, (CHAR*)"arValue", 143119);
    return 1;
  } else {
    return 0;
  }
  __RETCHK((CHAR*)"arValue", 144127);
}
...
arValue_IntArray arValue_List_ToIntArray (arValue_List self)
{
  ...
  while (it != NIL) {
    if (__ISP(it->value, arValue_Integer__rec, 1)) {
      (result->data)[__X(i, result->len[0], (CHAR*)"arValue", 170279)] = (__GUARDP(it->value, arValue_Integer__rec, 1))->value;
      i += 1;
    }
    it = it->next;
  }
  __ASSERT(i == count, 0, (CHAR*)"arValue", 171538);
  return result;
}
...
arValue_StringArray arValue_List_ToStringArray (arValue_List self)
{
  ...
  result = __NEWARR(POINTER__typ, 8, 8, 1, 1, (SYSTEM_ARRLEN)count);
  it = self->first;
  i = 0;
  while (it != NIL) {
    if (__ISP(it->value, arValue_String__rec, 1)) {
      (result->data)[__X(i, result->len[0], (CHAR*)"arValue", 177446)] = (__GUARDP(it->value, arValue_String__rec, 1))->value;
      i += 1;
    }
    it = it->next;
  }
  __ASSERT(i == count, 0, (CHAR*)"arValue", 178706);
  return result;
}
...
arValue_ObjectArray arValue_List_ToObjectArray (arValue_List self)
{
  ...
  result = __NEWARR(POINTER__typ, 8, 8, 1, 1, (SYSTEM_ARRLEN)self->length);
  it = self->first;
  i = 0;
  while (it != NIL) {
    (result->data)[__X(i, result->len[0], (CHAR*)"arValue", 182295)] = it->value;
    i += 1;
    it = it->next;
  }
  __ASSERT(i == self->length, 0, (CHAR*)"arValue", 183320);
  return result;
}
...
{
  arValue_ListElement it = NIL;
  __ASSERT(index >= 0 && index < self->length, 0, (CHAR*)"arValue", 187437);
  it = self->first;
  while (index > 0) {
    it = it->next;
    index -= 1;
...
{
  arValue_ListElement it = NIL;
  __ASSERT(index >= 0 && index < self->length, 0, (CHAR*)"arValue", 190253);
  it = self->first;
  while (index > 0) {
    it = it->next;
    index -= 1;
...
arValue_List arValue_String_Split (arValue_String self, CHAR separator)
{
  ...
  i = 0;
  while (i <= _for__39) {
    if ((self->value->data)[__X(i, self->value->len[0], (CHAR*)"arValue", 203269)] == separator) {
...
static arValue_Array arValue_NewArray (INTEGER length)
{
  ...
  __NEW(a, arValue_Array__rec);
  a->length = length;
  a->value = __NEWARR(POINTER__typ, 8, 8, 1, 1, (SYSTEM_ARRLEN)length);
  return a;
}
...
static arValue_Array arValue_Array_CopyT (arValue_Array self, BOOLEAN deep)
{
  ...
  i = 0;
  while (i <= _for__48) {
    value = (self->value->data)[__X(i, self->value->len[0], (CHAR*)"arValue", 253976)];
    if (deep) {
      value = arValue_DeepCopy(value);
    }
    (a->value->data)[__X(i, a->value->len[0], (CHAR*)"arValue", 254485)] = value;
    i += 1;
  }
  __RETCHK((CHAR*)"arValue", 253724);
}
...
void arValue_Array_Format (arValue_Array self, arText_Writer *w, void **w__typ)
{
  ...
  while (i <= _for__53) {
    ...
    arValue_FormatQ(w, w__typ, (self->value->data)[__X(i, self->value->len[0], (CHAR*)"arValue", 259867)]);
    i += 1;
  }
  __arText_Stream_Char((void*)w, w__typ, ']');
}
...
BOOLEAN arValue_Array_Equals (arValue_Array self, arValue_Object value)
{
  ...
  if (__ISP(value, arValue_Array__rec, 1)) {
    ...
    i = 0;
    while (i <= _for__51) {
      if (!arValue_Equals((self->value->data)[__X(i, self->value->len[0], (CHAR*)"arValue", 262722)], (((arValue_Array)value)->value->data)[__X(i, ((arValue_Array)value)->value->len[0], (CHAR*)"arValue", 262722)])) {
        return 0;
      }
      i += 1;
    }
  ...
  __RETCHK((CHAR*)"arValue", 263935);
}

/*----------------------------------------------------------------------------*/
arValue_Object arValue_Array_Get (arValue_Array self, INTEGER index)
{
  __ASSERT(index >= 0 && index < self->length, 0, (CHAR*)"arValue", 265261);
  return (self->value->data)[__X(index, self->value->len[0], (CHAR*)"arValue", 265497)];
}

/*----------------------------------------------------------------------------*/
arValue_Object arValue_Array_Set (arValue_Array self, INTEGER index, arValue_Object value)
{
  __ASSERT(index >= 0 && index < self->length, 0, (CHAR*)"arValue", 266797);
  (self->value->data)[__X(index, self->value->len[0], (CHAR*)"arValue", 267035)] = value;
  __RETCHK((CHAR*)"arValue", 267035);
}
...
arValue_Array arValue_array2 (arValue_Object a, arValue_Object b)
{
  ...
  (result->value->data)[__X(1, result->value->len[0], (CHAR*)"arValue", 279573)] = b;
  return result;
}
...
arValue_Array arValue_array3 (arValue_Object a, arValue_Object b, arValue_Object c)
{
  ...
  (result->value->data)[0] = a;
  (result->value->data)[__X(1, result->value->len[0], (CHAR*)"arValue", 281877)] = b;
  (result->value->data)[__X(2, result->value->len[0], (CHAR*)"arValue", 282133)] = c;
  return result;
}
...
arValue_Array arValue_array4 (arValue_Object a, arValue_Object b, arValue_Object c, arValue_Object d)
{
  ...
  result = arValue_NewArray(3);
  (result->value->data)[0] = a;
  (result->value->data)[__X(1, result->value->len[0], (CHAR*)"arValue", 284437)] = b;
  (result->value->data)[__X(2, result->value->len[0], (CHAR*)"arValue", 284693)] = c;
  (result->value->data)[__X(3, result->value->len[0], (CHAR*)"arValue", 284949)] = d;
  return result;
}
...
/*----------------------------------------------------------------------------*/
__TDESC(arValue_ObjectDesc__desc, 7, 0) = {__TDFLDS("ObjectDesc", 1), {-8}};
__TDESC(arValue_String__rec__desc, 16, 1) = {__TDFLDS("String__rec", 16), {0, -16}};
__TDESC(arValue_Boolean__rec__desc, 8, 0) = {__TDFLDS("Boolean__rec", 1), {-8}};
__TDESC(arValue_Integer__rec__desc, 8, 0) = {__TDFLDS("Integer__rec", 4), {-8}};
__TDESC(arValue_Real__rec__desc, 8, 0) = {__TDFLDS("Real__rec", 8), {-8}};
__TDESC(arValue_Set__rec__desc, 8, 0) = {__TDFLDS("Set__rec", 4), {-8}};
__TDESC(arValue_ListElement__rec__desc, 2, 2) = {__TDFLDS("ListElement__rec", 16), {0, 8, -24}};
__TDESC(arValue_List__rec__desc, 21, 2) = {__TDFLDS("List__rec", 24), {0, 8, -24}};
__TDESC(arValue_Array__rec__desc, 10, 1) = {__TDFLDS("Array__rec", 16), {0, -16}};
__TDESC(arValue_RecordElement__rec__desc, 2, 3) = {__TDFLDS("RecordElement__rec", 24), {0, 8, 16, -32}};
__TDESC(arValue_Record__rec__desc, 12, 2) = {__TDFLDS("Record__rec", 24), {0, 16, -24}};
