...
__TDESC(Texts_FontDesc__desc, 2, 0) = {__TDFLDS("FontDesc", 32), {-8}};
__TDESC(Texts_RunDesc__desc, 1, 3) = {__TDFLDS("RunDesc", 40), {0, 8, 24, -32}};
__TDESC(Texts_PieceDesc__desc, 1, 4) = {__TDFLDS("PieceDesc", 56), {0, 8, 24, 40, -40}};
__TDESC(Texts_ElemMsg__desc, 1, 0) = {__TDFLDS("ElemMsg", 1), {-8}};
__TDESC(Texts_ElemDesc__desc, 1, 4) = {__TDFLDS("ElemDesc", 64), {0, 8, 24, 56, -40}};
__TDESC(Texts_FileMsg__desc, 1, 1) = {__TDFLDS("FileMsg", 40), {16, -16}};
__TDESC(Texts_CopyMsg__desc, 1, 1) = {__TDFLDS("CopyMsg", 8), {0, -16}};
__TDESC(Texts_IdentifyMsg__desc, 1, 0) = {__TDFLDS("IdentifyMsg", 64), {-8}};
__TDESC(Texts_BufDesc__desc, 2, 1) = {__TDFLDS("BufDesc", 16), {8, -16}};
__TDESC(Texts_TextDesc__desc, 1, 2) = {__TDFLDS("TextDesc", 40), {16, 24, -24}};
__TDESC(Texts_Reader__desc, 2, 4) = {__TDFLDS("Reader", 80), {8, 24, 40, 64, -40}};
__TDESC(Texts_Scanner__desc, 2, 4) = {__TDFLDS("Scanner", 176), {8, 24, 40, 64, -40}};
__TDESC(Texts_Writer__desc, 2, 4) = {__TDFLDS("Writer", 64), {0, 8, 32, 56, -40}};
__TDESC(Texts_Alien__rec__desc, 1, 5) = {__TDFLDS("Alien__rec", 144), {0, 8, 24, 56, 64, -48}};
