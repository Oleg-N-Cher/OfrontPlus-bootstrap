...
void OfrontOPC_Ident (OfrontOPT_Object obj)
{
  ...
  if (obj->entry != NIL && (INTEGER)level <= 0) {
    ...
    h = (_ptr__71 = obj->name, 
      OfrontOPC_PerfectHash((void*)_ptr__71->data, _ptr__71->len[0]));
    ...
    if ((INTEGER)mode != 5 || obj->linkadr != 2) {
      if ((INTEGER)mode == 13) {
        ...
        if (!OfrontOPC_oldc) {
          _ptr__70 = OfrontOPT_GlbMod[__X(-((INTEGER)level), 64, (CHAR*)"OfrontOPC", 58111)]->name;
    ...
    _ptr__69 = obj->name;
    OfrontOPC_WriteName((void*)_ptr__69->data, _ptr__69->len[0]);
  }
}
...
INTEGER OfrontOPC_NofPtrs (OfrontOPT_Struct typ)
{
  ...
  if ((INTEGER)typ->form == 13 && (INTEGER)typ->sysflag == 0) {
    ...
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if (__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 102663) != 0) {
  ...
  __RETCHK((CHAR*)"OfrontOPC", 104959);
}
...
static void OfrontOPC_PutPtrOffsets (OfrontOPT_Struct typ, INTEGER adr, INTEGER *cnt)
{
  ...
  if ((INTEGER)typ->form == 13 && (INTEGER)typ->sysflag == 0) {
    ...
    *cnt += 1;
    ...
    fld = typ->link;
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if (__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 109575) != 0) {
...
{
  INTEGER i;
  __ASSERT(__IN(typ->comp, 0x0c), 0, (CHAR*)"OfrontOPC", 149797);
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    if (OfrontOPT_EqualType(typ, OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 150583)])) {
      return;
    }
    i += 1;
  }
  OfrontOPC_arrayTypes[__X(OfrontOPC_arrayIndex, 1024, (CHAR*)"OfrontOPC", 151327)] = typ;
...
void OfrontOPC_CleanupArrays (void)
{
  ...
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 153390)] = NIL;
    i += 1;
  }
}
  ...
  if (3 <= (INTEGER)sysflag && (INTEGER)sysflag <= 6) {
    ...
    switch (sysflag) {
      ...
      case 6: 
        OfrontOPM_Write('8');
        break;
      default: __CASECHK((CHAR*)"OfrontOPC", 165119);
    }
    OfrontOPM_Write(')');
    OfrontOPM_WriteLn();
  }
...
static BOOLEAN OfrontOPC_Prefixed (OfrontOPS_String x, CHAR *y, INTEGER y__len)
{
  INTEGER i;
  i = 0;
  while (i < x->len[0] && (x->data)[__X(i, x->len[0], (CHAR*)"OfrontOPC", 185636)] == y[__X(i, y__len, (CHAR*)"OfrontOPC", 185636)]) {
    i += 1;
  }
  return y[__X(i, y__len, (CHAR*)"OfrontOPC", 186111)] == 0x00;
}
  ...
  if (obj != NIL) {
    ...
    if (((INTEGER)obj->mode == 9 && (INTEGER)obj->vis >= (INTEGER)vis) && obj->adr == 1) {
      ...
      if (ext != NIL) {
        ...
        i = 0;
        while (i <= _for__11) {
          OfrontOPM_Write((ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPC", 190006)]);
          i += 1;
        }
      } else {
        OfrontOPM_WriteString((CHAR*)"import ", 8);
...
{
  OfrontOPT_Object p = NIL;
  OfrontOPS_String _ptr__115 = NIL;
  if (check && typ == initial) {
  } else if (__IN(typ->form, 0x0243fe)) {
    if (typ->BaseTyp != OfrontOPT_undftyp) {
      typ = typ->BaseTyp;
    }
    _ptr__115 = typ->strobj->name;
    OfrontOPM_WriteString((void*)_ptr__115->data, _ptr__115->len[0]);
  } else if (typ == OfrontOPT_sysptrtyp) {
    OfrontOPC_Ident(typ->strobj);
  } else {
    if ((INTEGER)typ->comp == 4) {
      __ASSERT(typ->strobj != NIL && (typ->strobj->name->data)[0] != 0x00, 100, (CHAR*)"OfrontOPC", 209469);
      OfrontOPC_Ident(typ->strobj);
    } else if ((INTEGER)typ->comp == 2) {
      __ASSERT(typ->strobj != NIL && (typ->strobj->name->data)[0] != 0x00, 100, (CHAR*)"OfrontOPC", 210237);
      OfrontOPC_Ident(typ->strobj);
      ...
      __HALT(100, (CHAR*)"OfrontOPC", 215039);
    }
  }
}
...
static void OfrontOPC_DefAnonArrays (void)
{
  ...
  i = 0;
  while (i < OfrontOPC_arrayIndex) {
    atyp = OfrontOPC_arrayTypes[__X(i, 1024, (CHAR*)"OfrontOPC", 218648)];
    typ = atyp;
...
void OfrontOPC_TDescDecl (OfrontOPT_Struct typ)
{
  ...
  if (__MASK((INTEGER)typ->sysflag, -256) == 0) {
    ...
    OfrontOPM_Write('\"');
    if (typ->strobj != NIL) {
      _ptr__107 = typ->strobj->name;
      OfrontOPC_WriteName((void*)_ptr__107->data, _ptr__107->len[0]);
    }
...
static BOOLEAN OfrontOPC_HasPtrs (OfrontOPT_Struct typ)
{
  ...
  if (__IN(typ->form, 0xa000)) {
    ...
    fld = typ->link;
    while (fld != NIL && (INTEGER)fld->mode == 4) {
      if ((__STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPC", 262507) == 0 || __STRCMPCC(fld->name->data, (CHAR*)"@proc", 6, (CHAR*)"OfrontOPC", 262507) == 0) || OfrontOPC_HasPtrs(fld->typ)) {
        return 1;
      }
      fld = fld->link;
    }
...
static struct WriteConstArr__118 {
  struct WriteConstArr__118 *lnk;
} *WriteConstArr__118_s;

static void __121 (OfrontOPT_ConstArr arr, INTEGER i, OfrontOPT_Struct bt);
  ...
  switch (bt->size) {
    case 1: 
      if (__IN(bt->form, 0x4008)) {
        OfrontOPM_WriteInt(__MASK((INTEGER)(arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 267086)], -256));
      } else {
        OfrontOPM_WriteInt((arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 267117)]);
      }
      break;
    case 2: 
      if ((INTEGER)bt->form == 17) {
        OfrontOPM_WriteInt(__MASK((INTEGER)(arr->val1->data)[__X(i, arr->val1->len[0], (CHAR*)"OfrontOPC", 267335)], -65536));
      } else {
        OfrontOPM_WriteInt((arr->val2->data)[__X(i, arr->val2->len[0], (CHAR*)"OfrontOPC", 267366)]);
      }
      break;
    case 4: 
      OfrontOPM_WriteInt((arr->val4->data)[__X(i, arr->val4->len[0], (CHAR*)"OfrontOPC", 267775)]);
      break;
    case 8: 
      OfrontOPM_WriteInt((arr->val8->data)[__X(i, arr->val8->len[0], (CHAR*)"OfrontOPC", 268031)]);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 268031);
  }
}
...
static void OfrontOPC_WriteConstArr (OfrontOPT_Object *obj, OfrontOPT_Struct typ)
{
  ...
  INTEGER i, _for__120, _for__119;
  struct WriteConstArr__118 _s;
  _s.lnk = WriteConstArr__118_s;
  WriteConstArr__118_s = &_s;
  ...
  if ((INTEGER)typ->BaseTyp->form != 16) {
    ...
    i = 0;
    while (i <= _for__120) {
      __121((*obj)->conval->arr, i + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
      OfrontOPM_WriteString((CHAR*)",", 2);
      if (__MOD(i + 1, 10) == 0) {
        OfrontOPM_WriteLn();
        OfrontOPC_BegStat();
    ...
    __121((*obj)->conval->arr, (typ->n - 1) + (INTEGER)(*obj)->conval->intval, typ->BaseTyp);
...
static void OfrontOPC_IncludeImports (SHORTINT vis)
{
  ...
  while (i < (INTEGER)OfrontOPT_nofGmod) {
    mod = OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPC", 318743)];
    if ((INTEGER)mod->vis >= (INTEGER)vis) {
      _ptr__77 = mod->name;
      OfrontOPC_Include((void*)_ptr__77->data, _ptr__77->len[0]);
      if (__STRCMPCC(mod->name->data, (CHAR*)"WinApi", 7, (CHAR*)"OfrontOPC", 319743) == 0) {
        OfrontOPC_windows = 1;
      }
    }
    i += 1;
...
static void OfrontOPC_RegCmds (OfrontOPT_Object obj)
{
  OfrontOPS_String _ptr__101 = NIL;
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 7 && (INTEGER)obj->history != 4) {
      if (((INTEGER)obj->vis != 0 && obj->link == NIL) && obj->typ == OfrontOPT_notyp) {
        ...
        _ptr__101 = obj->name;
        OfrontOPM_WriteString((void*)_ptr__101->data, _ptr__101->len[0]);
        OfrontOPM_WriteString((CHAR*)"\", ", 4);
        OfrontOPC_Ident(obj);
        OfrontOPM_Write(')');
        OfrontOPC_EndStat();
...
static void OfrontOPC_InitImports (OfrontOPT_Object obj)
{
  OfrontOPS_String _ptr__82 = NIL;
  if (obj != NIL) {
    OfrontOPC_InitImports(obj->left);
    if (((INTEGER)obj->mode == 11 && (INTEGER)obj->mnolev != 0) && !__ODD(OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 353542)]->sysflag)) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__IMPORT(", 10);
      _ptr__82 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 353075)]->name;
      OfrontOPM_WriteString((void*)_ptr__82->data, _ptr__82->len[0]);
...
void OfrontOPC_EnterBody (void)
{
  ...
  OfrontOPC_EndStat();
  if (__STRCMPCC(OfrontOPM_modName, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPC", 372735) != 0) {
...
static void OfrontOPC_DoClose (OfrontOPT_Object obj)
{
  ...
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 11 && __ODD(__ASHR((INTEGER)OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 375558)]->sysflag, 1, INTEGER))) {
      OfrontOPC_BegStat();
      OfrontOPM_WriteString((CHAR*)"__CLOSE(", 9);
      _ptr__42 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 374835)]->name;
      OfrontOPM_WriteString((void*)_ptr__42->data, _ptr__42->len[0]);
      OfrontOPM_WriteString((CHAR*)"__init, ", 9);
      _ptr__41 = OfrontOPT_GlbMod[__X(-((INTEGER)obj->mnolev), 64, (CHAR*)"OfrontOPC", 375091)]->name;
...
void OfrontOPC_ExitProc (OfrontOPT_Object proc, BOOLEAN eoBlock, BOOLEAN implicitRet)
{
  ...
  if (implicitRet && proc->typ != OfrontOPT_notyp) {
    ...
    if (!proc->scope->leaf) {
      ...
      _ptr__55 = proc->scope->name;
      OfrontOPM_WriteString((void*)_ptr__55->data, _ptr__55->len[0]);
      OfrontOPM_WriteString((CHAR*)"_s", 3);
      OfrontOPM_WriteString((CHAR*)" = ", 4);
      OfrontOPM_WriteString((CHAR*)"_s", 3);
      OfrontOPM_Write('.');
...
{
  OfrontOPS_String _ptr__110 = NIL;
  __ASSERT((INTEGER)ap->typ->comp == 4, 0, (CHAR*)"OfrontOPC", 439070);
  if ((INTEGER)ap->mode == 2) {
    if ((INTEGER)ap->mnolev != OfrontOPM_level) {
      _ptr__110 = ap->scope->name;
      OfrontOPM_WriteString((void*)_ptr__110->data, _ptr__110->len[0]);
...
void OfrontOPC_Cmp (SHORTINT rel)
{
  switch (rel) {
    ...
    case 16: 
      OfrontOPM_WriteString((CHAR*)" >= ", 5);
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 446236);
  }
}
...
static void OfrontOPC_WriteCharLiteral (LONGCHAR ch, BOOLEAN wide)
{
  if (ch >= ' ' && ch <= '~') {
    ...
    __ASSERT(ch <= 0xff, 0, (CHAR*)"OfrontOPC", 449557);
    OfrontOPM_WriteString((CHAR*)"0x", 3);
...
static void OfrontOPC_WriteStringLiteral (CHAR *str, INTEGER str__len, INTEGER len)
{
  ...
  i = 0;
  while (i < len) {
    ch = str[__X(i, str__len, (CHAR*)"OfrontOPC", 451871)];
    if (ch >= ' ' && ch <= '~') {
      if (((ch == '\\' || ch == '\?') || ch == '\'') || ch == '\"') {
        OfrontOPM_Write('\\');
      }
      ...
      if (i + 1 < len) {
        switch (str[__X(i + 1, str__len, (CHAR*)"OfrontOPC", 453908)]) {
...
void OfrontOPC_Case (INTEGER caseVal, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 1: case 14: case 4: case 5: case 6: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 458751);
  }
  OfrontOPM_WriteString((CHAR*)": ", 3);
}
...
void OfrontOPC_Constant (OfrontOPT_Const con, SHORTINT form)
{
  ...
  switch (form) {
    ...
    case 11: 
      ...
      break;
    default: __CASECHK((CHAR*)"OfrontOPC", 478719);
  }
}

/*----------------------------------------------------------------------------*/
static struct InitKeywords__83 {
  SHORTINT *n;
  struct InitKeywords__83 *lnk;
} *InitKeywords__83_s;

static void __84 (CHAR *s, INTEGER s__len);

static void __84 (CHAR *s, INTEGER s__len)
{
  SHORTINT h;
  h = OfrontOPC_PerfectHash((void*)s, s__len);
  OfrontOPC_hashtab[__X(h, 169, (CHAR*)"OfrontOPC", 481068)] = (*InitKeywords__83_s->n);
  __STRCOPYCC(s, OfrontOPC_keytab[__X((*InitKeywords__83_s->n), 37, (CHAR*)"OfrontOPC", 481085)], __MIN(9, s__len), (CHAR*)"OfrontOPC", 481085);
  (*InitKeywords__83_s->n) += 1;
}

static void OfrontOPC_InitKeywords (void)
{
  SHORTINT n, i;
  struct InitKeywords__83 _s;
  _s.n = &n;
  _s.lnk = InitKeywords__83_s;
  InitKeywords__83_s = &_s;
  n = 0;
  i = 0;
  while ((INTEGER)i <= 168) {
    OfrontOPC_hashtab[__X(i, 169, (CHAR*)"OfrontOPC", 482100)] = -1;
    i += 1;
  }
  __84((CHAR*)"asm", 4);
  __84((CHAR*)"auto", 5);
  ...
  __84((CHAR*)"typedef", 8);
  __84((CHAR*)"union", 6);
  __84((CHAR*)"unsigned", 9);
  __84((CHAR*)"void", 5);
  __84((CHAR*)"volatile", 9);
  __84((CHAR*)"while", 6);
  InitKeywords__83_s = _s.lnk;
}
