...
{
  __ASSERT(y != 0, -1, (CHAR*)"OfrontOPM", 34319);
...
{
  __ASSERT(y != 0, -1, (CHAR*)"OfrontOPM", 35599);
  return x / y;
}
...
{
  __ASSERT(y != 0, -1, (CHAR*)"OfrontOPM", 36879);
  return x % y;
}
...
{
  __ASSERT(0 <= n && n <= 63, -1, (CHAR*)"OfrontOPM", 38174);
...
{
  __ASSERT(0 <= n && n <= 63, -1, (CHAR*)"OfrontOPM", 39710);
  return __LSH(x, -n, LONGINT);
}
...
{
  __ASSERT(0 <= n && n <= 63, -1, (CHAR*)"OfrontOPM", 41246);
...
{
  __ASSERT(val >= 0 && val < 65536, -1, (CHAR*)"OfrontOPM", 56356);
  if (val < 128) {
...
void OfrontOPM_WriteString (CHAR *s, INTEGER s__len)
{
  ...
  if (OfrontOPM_currFile != -1) {
    ...
    Files_WriteBytes(&OfrontOPM_R[__X(OfrontOPM_currFile, 3, (CHAR*)"OfrontOPM", 177151)], Files_Rider__typ, (void*)(SYSTEM_ADRINT)s, (LONGINT)i, i);
  }
}
