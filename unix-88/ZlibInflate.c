...
{
  __ENUMR(&ZlibInflate_FixedLitLenTree, ZlibInflate_Tree__typ, 16, 1, P);
  __ENUMR(&ZlibInflate_FixedDistTree, ZlibInflate_Tree__typ, 16, 1, P);
}

__TDESC(ZlibInflate_Result__desc, 2, 1) = {__TDFLDS("Result", 16), {8, -16}};
__TDESC(ZlibInflate_Code__desc, 2, 0) = {__TDFLDS("Code", 102), {-8}};
__TDESC(ZlibInflate_Node__desc, 2, 0) = {__TDFLDS("Node", 4), {-8}};
__TDESC(ZlibInflate_TreeNodes__desc, 1, 1) = {__TDFLDS("TreeNodes", 16), {0, -16}};
__TDESC(ZlibInflate_Tree__desc, 1, 1) = {__TDFLDS("Tree", 16), {0, -16}};
__TDESC(ZlibInflate__1__desc, 2, 0) = {__TDFLDS("", 8), {-8}};
__TDESC(ZlibInflate__2__desc, 2, 0) = {__TDFLDS("", 16), {-8}};
__TDESC(ZlibInflate__3__desc, 2, 2) = {__TDFLDS("", 360), {336, 344, -24}};
__TDESC(ZlibInflate__4__desc, 2, 3) = {__TDFLDS("", 64), {8, 24, 40, -32}};
__TDESC(ZlibInflate_Stream__desc, 2, 7) = {__TDFLDS("Stream", 568), {72, 88, 480, 488, 512, 528, 544, -64}};
