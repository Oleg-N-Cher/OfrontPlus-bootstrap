...
/*----------------------------------------------------------------------------*/
__TDESC(arText_Stream__desc, 4, 0) = {__TDFLDS("Stream", 1), {-4}};
__TDESC(arText_Writer__desc, 12, 0) = {__TDFLDS("Writer", 26), {-4}};
__TDESC(arText_StreamWriter__desc, 13, 1) = {__TDFLDS("StreamWriter", 32), {28, -8}};
__TDESC(arText_Buffer__desc, 17, 1) = {__TDFLDS("Buffer", 40), {36, -8}};
