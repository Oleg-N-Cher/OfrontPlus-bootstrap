...
__TDESC(Files_FileDesc__desc, 2, 4) = {__TDFLDS("FileDesc", 584), {560, 564, 568, 572, -20}};
__TDESC(Files_BufDesc__desc, 1, 1) = {__TDFLDS("BufDesc", 4120), {0, -8}};
__TDESC(Files_Rider__desc, 1, 1) = {__TDFLDS("Rider", 32), {8, -8}};
