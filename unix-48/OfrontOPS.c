  ...
  switch (OfrontOPS_name[0]) {
    ...
    case 'W': 
      if (__STRCMPCC(OfrontOPS_name, (CHAR*)"WHILE", 6, (CHAR*)"OfrontOPS", 45311) == 0) {
        *sym = 49;
      } else if (OfrontOPM_Lang != '7' && __STRCMPCC(OfrontOPS_name, (CHAR*)"WITH", 5, (CHAR*)"OfrontOPS", 44799) == 0) {
        *sym = 53;
      }
      break;
    default: 
  ...
  switch (__CAP(OfrontOPS_name[0])) {
    ...
    case 'W': 
      if (OfrontOPS_Cmp((CHAR*)"WHILE", 6, (CHAR*)"while", 6)) {
        *sym = 49;
      } else if (OfrontOPS_Cmp((CHAR*)"WITH", 5, (CHAR*)"with", 5)) {
        *sym = 53;
      }
      break;
    default: 
  ...
  if (d == 0) {
    if (n == m) {
      ...
      if (OfrontOPS_ch == 'X') {
        ...
        OfrontOPM_Get(&OfrontOPS_ch);
        OfrontOPS_numtyp = 2;
        if (OfrontOPM_Lang == '3' || OfrontOPM_Lang == '7') {
          m = 16;
        } else {
          m = 8;
        }
      ...
      } else if ((OfrontOPS_ch == 'L' && OfrontOPM_Lang != '3') && OfrontOPM_Lang != '7') {
        OfrontOPM_Get(&OfrontOPS_ch);
        OfrontOPS_numtyp = 2;
        if (n <= 16) {
          if (n == 16 && dig[0] > '7') {
          ...
          while (i < n) {
            OfrontOPS_intval = __ASHL(OfrontOPS_intval, 4, LONGINT) + (LONGINT)__13(dig[__X(i, 24, (CHAR*)"OfrontOPS", 86845)], 1);
            i += 1;
          }
        } else {
          OfrontOPS_err(203);
        ...
        OfrontOPS_numtyp = 2;
        while (i < n) {
          d = __13(dig[__X(i, 24, (CHAR*)"OfrontOPS", 87851)], 0);
          i += 1;
    ...
    expCh = 'E';
    while (j < 15 && j < n) {
      g = g * (REAL)10 + (REAL)__13(dig[__X(j, 24, (CHAR*)"OfrontOPS", 90687)], 0);
      j += 1;
    }
    while (n > j) {
      n -= 1;
      f = ((REAL)__13(dig[__X(n, 24, (CHAR*)"OfrontOPS", 90955)], 0) + f) / (REAL)(REAL)10;
    }
...
static void __6 (INTEGER len)
{
  ...
  if (len > OfrontOPS_str->len[0]) {
    ...
    j = 0;
    while (j <= _for__8) {
      (s2->data)[__X(j, s2->len[0], (CHAR*)"OfrontOPS", 105029)] = (OfrontOPS_str->data)[__X(j, OfrontOPS_str->len[0], (CHAR*)"OfrontOPS", 105029)];
      j += 1;
    }
    OfrontOPS_str = s2;
  }
...
static BOOLEAN __4 (void)
{
  ...
  for (;;) {
    ...
    if (OfrontOPS_ch == '*') {
      ...
      if (OfrontOPS_ch == ')') {
        OfrontOPM_Get(&OfrontOPS_ch);
        (OfrontOPS_str->data)[__X(n, OfrontOPS_str->len[0], (CHAR*)"OfrontOPS", 111663)] = 0x00;
        break;
      }
      __6(n + 1);
      (OfrontOPS_str->data)[__X(n, OfrontOPS_str->len[0], (CHAR*)"OfrontOPS", 111908)] = '*';
      n += 1;
    }
    if (OfrontOPS_ch == 0x00) {
      OfrontOPS_err(5);
      (OfrontOPS_str->data)[__X(n, OfrontOPS_str->len[0], (CHAR*)"OfrontOPS", 112429)] = 0x00;
      break;
    }
    __6(n + 1);
    (OfrontOPS_str->data)[__X(n, OfrontOPS_str->len[0], (CHAR*)"OfrontOPS", 112681)] = (CHAR)OfrontOPS_ch;
    n += 1;
  }
  __retval = 0;
  __4__5_s = _s.lnk;
