...
__TDESC(Texts_FileMsg__desc, 1, 1) = {__TDFLDS("FileMsg", 40), {16, -8}};
...
__TDESC(Texts_Reader__desc, 1, 4) = {__TDFLDS("Reader", 64), {4, 12, 24, 48, -20}};
__TDESC(Texts_Scanner__desc, 1, 4) = {__TDFLDS("Scanner", 160), {4, 12, 24, 48, -20}};
__TDESC(Texts_Writer__desc, 1, 4) = {__TDFLDS("Writer", 56), {0, 4, 24, 48, -20}};
