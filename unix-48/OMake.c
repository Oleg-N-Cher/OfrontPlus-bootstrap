...
__TDESC(OMake_Keyword__rec__desc, 2, 2) = {__TDFLDS("Keyword__rec", 12), {0, 8, -12}};
__TDESC(OMake_Import__rec__desc, 2, 3) = {__TDFLDS("Import__rec", 12), {0, 4, 8, -16}};
__TDESC(OMake_Module__rec__desc, 2, 7) = {__TDFLDS("Module__rec", 32), {0, 4, 12, 16, 20, 24, 28, -32}};
