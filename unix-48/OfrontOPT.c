...
static void OfrontOPT_IdFPrint (OfrontOPT_Struct typ)
{
  ...
  if (!typ->idfpdone) {
    ...
    if (strobj != NIL && strobj->name != OfrontOPT_null) {
      _ptr__35 = OfrontOPT_GlbMod[__X(typ->mno, 64, (CHAR*)"OfrontOPT", 106797)]->name;
      OfrontOPT_FPrintName(&idfp, (void*)_ptr__35->data, _ptr__35->len[0]);
      _ptr__34 = strobj->name;
      OfrontOPT_FPrintName(&idfp, (void*)_ptr__34->data, _ptr__34->len[0]);
    }
...
static struct FPrintStr__19 {
  INTEGER *pbfp, *pvfp;
  struct FPrintStr__19 *lnk;
} *FPrintStr__19_s;

static void __20 (OfrontOPT_Object fld, INTEGER adr, BOOLEAN visible);
static void __23 (OfrontOPT_Struct typ, OfrontOPT_Object fld, INTEGER adr);
static void __25 (OfrontOPT_Object obj);
...
static void __23 (OfrontOPT_Struct typ, OfrontOPT_Object fld, INTEGER adr)
{
  ...
  if ((INTEGER)typ->comp == 4) {
    ...
    OfrontOPM_FPrint(&(*FPrintStr__19_s->pvfp), 13);
    OfrontOPM_FPrint(&(*FPrintStr__19_s->pvfp), adr);
...
static void __20 (OfrontOPT_Object fld, INTEGER adr, BOOLEAN visible)
{
  OfrontOPS_String _ptr__22 = NIL;
  while (fld != NIL && (INTEGER)fld->mode == 4) {
    if ((INTEGER)fld->vis != 0 && visible) {
      OfrontOPM_FPrint(&(*FPrintStr__19_s->pbfp), fld->vis);
      _ptr__22 = fld->name;
      OfrontOPT_FPrintName(&(*FPrintStr__19_s->pbfp), (void*)_ptr__22->data, _ptr__22->len[0]);
      OfrontOPM_FPrint(&(*FPrintStr__19_s->pbfp), fld->adr);
      OfrontOPT_FPrintStr(fld->typ);
      OfrontOPM_FPrint(&(*FPrintStr__19_s->pbfp), fld->typ->pbfp);
      OfrontOPM_FPrint(&(*FPrintStr__19_s->pvfp), fld->typ->pvfp);
    } else {
      __23(fld->typ, fld, fld->adr + adr);
    }
    fld = fld->link;
  }
}
  ...
  if (obj != NIL) {
    ...
    if ((INTEGER)obj->mode == 13) {
      if ((INTEGER)obj->vis != 0) {
        ...
        _ptr__27 = obj->name;
        OfrontOPT_FPrintName(&fp, (void*)_ptr__27->data, _ptr__27->len[0]);
        OfrontOPM_FPrint(&(*FPrintStr__19_s->pvfp), fp);
        OfrontOPM_FPrint(&(*FPrintStr__19_s->pbfp), fp);
      }
    }
    __25(obj->right);
  }
...
static void OfrontOPT_FPrintStr (OfrontOPT_Struct typ)
{
  ...
  INTEGER pbfp, pvfp;
  struct FPrintStr__19 _s;
  _s.pbfp = &pbfp;
  _s.pvfp = &pvfp;
  _s.lnk = FPrintStr__19_s;
  FPrintStr__19_s = &_s;
  if (!typ->fpdone) {
...
static void OfrontOPT_FPrintObj (OfrontOPT_Object obj)
{
  ...
  if (!obj->fpdone) {
    ...
    if (__IN(obj->mode, 0xc2) && obj->entry != NIL) {
      _ptr__16 = obj->entry;
      OfrontOPT_FPrintName(&fprint, (void*)_ptr__16->data, _ptr__16->len[0]);
    }
    obj->fprint = fprint;
  }
}
  ...
  if (mn == 0) {
    *mno = OfrontOPT_impCtxt.glbmno[0];
    ...
    if (mn == 16) {
      ...
      if (__STRCMPCC(name->data, OfrontOPT_SelfName, 48, (CHAR*)"OfrontOPT", 162619) == 0 && !OfrontOPT_impCtxt.self) {
        OfrontOPT_err(154);
      }
      i = 0;
      while ((INTEGER)i < (INTEGER)OfrontOPT_nofGmod && __STRCMPCC(name->data, OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPT", 163123)]->name->data, OfrontOPT_GlbMod[__X(i, 64, (CHAR*)"OfrontOPT", 163123)]->name->len[0], (CHAR*)"OfrontOPT", 163123) != 0) {
        i += 1;
      }
      if ((INTEGER)i < (INTEGER)OfrontOPT_nofGmod) {
        ...
        *mno = OfrontOPT_nofGmod;
        ...
        if ((INTEGER)OfrontOPT_nofGmod < 64) {
          OfrontOPT_GlbMod[__X(*mno, 64, (CHAR*)"OfrontOPT", 164889)] = head;
          OfrontOPT_nofGmod += 1;
        } else {
          OfrontOPT_err(227);
        }
      }
      OfrontOPT_impCtxt.glbmno[__X(OfrontOPT_impCtxt.nofm, 64, (CHAR*)"OfrontOPT", 165927)] = *mno;
      OfrontOPT_impCtxt.nofm += 1;
    } else {
      *mno = OfrontOPT_impCtxt.glbmno[__X(-mn, 64, (CHAR*)"OfrontOPT", 166655)];
    }
  }
}
  ...
  switch (f) {
    ...
    case 10: case 18: 
      ...
      do {
        OfrontOPM_SymRCh(&ch);
        if (i < 47) {
          str[__X(i, 48, (CHAR*)"OfrontOPT", 173823)] = ch;
        } else if (i == 47) {
          str[__X(i, 48, (CHAR*)"OfrontOPT", 173868)] = 0x00;
          ext = __NEWARR(NIL, 1, 1, 1, 1, (SYSTEM_ARRLEN)96);
          __STRCOPYCC(str, ext->data, __MIN(ext->len[0], 48), (CHAR*)"OfrontOPT", 173906);
          (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 174079)] = ch;
        } else if (i < ext->len[0] - 1) {
          (ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 174335)] = ch;
        } else {
          t = ext;
          (t->data)[__X(i, t->len[0], (CHAR*)"OfrontOPT", 174365)] = 0x00;
          ext = __NEWARR(NIL, 1, 1, 1, 1, (SYSTEM_ARRLEN)(__ASHL(t->len[0], 1, INTEGER)));
          __STRCOPYCC(t->data, ext->data, __MIN(ext->len[0], t->len[0]), (CHAR*)"OfrontOPT", 174401);
      ...
      if (i < 48) {
        ...
        __STRCOPYCC(str, ext->data, __MIN(ext->len[0], 48), (CHAR*)"OfrontOPT", 175409);
      }
      conval->ext = ext;
      conval->intval = -1;
      if (f == 10) {
    ...
    case 11: 
      conval->intval = 0;
      break;
    default: __CASECHK((CHAR*)"OfrontOPT", 177919);
  }
}
...
static void OfrontOPT_InStruct (OfrontOPT_Struct *typ)
{
  ...
  tag = (INTEGER)OfrontOPM_SymRInt();
  if (tag != 34) {
    *typ = OfrontOPT_impCtxt.ref[__X(-tag, 1754, (CHAR*)"OfrontOPT", 198143)];
  } else {
    ...
    if (name == OfrontOPT_null) {
      if (OfrontOPT_impCtxt.self) {
        ...
        OfrontOPT_InsertImport(obj, &OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 199765)]->right, &old);
        obj->name = OfrontOPT_null;
      }
      *typ = OfrontOPT_NewStr(0, 1);
    } else {
      obj->name = name;
      OfrontOPT_InsertImport(obj, &OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 200516)]->right, &old);
      if (old != NIL) {
        OfrontOPT_FPrintObj(old);
        OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 201016)] = old->typ->pvfp;
        if (OfrontOPT_impCtxt.self) {
          *typ = OfrontOPT_NewStr(0, 1);
        } else {
          *typ = old->typ;
    ...
    OfrontOPT_impCtxt.ref[__X(ref, 1754, (CHAR*)"OfrontOPT", 203546)] = *typ;
    OfrontOPT_impCtxt.old[__X(ref, 1754, (CHAR*)"OfrontOPT", 203571)] = old;
    ...
    switch (tag) {
      ...
      case 39: case 26: case 25: case 27: 
        ...
        last = NIL;
        while ((OfrontOPT_impCtxt.nextTag >= 25 && OfrontOPT_impCtxt.nextTag <= 28) || OfrontOPT_impCtxt.nextTag == 35) {
          fld = OfrontOPT_InFld();
      ...
      case 20: 
        ...
        (*typ)->BaseTyp = t;
        break;
      default: __CASECHK((CHAR*)"OfrontOPT", 216575);
    }
    if ((INTEGER)ref == (INTEGER)OfrontOPT_impCtxt.minr) {
      while ((INTEGER)ref < (INTEGER)OfrontOPT_impCtxt.nofr) {
        t = OfrontOPT_impCtxt.ref[__X(ref, 1754, (CHAR*)"OfrontOPT", 217370)];
        OfrontOPT_FPrintStr(t);
        obj = t->strobj;
        if (obj->name != OfrontOPT_null) {
          OfrontOPT_FPrintObj(obj);
        }
        old = OfrontOPT_impCtxt.old[__X(ref, 1754, (CHAR*)"OfrontOPT", 218140)];
        if (old != NIL) {
          t->strobj = old;
          if (OfrontOPT_impCtxt.self) {
            if ((INTEGER)old->mnolev < 0) {
              if ((INTEGER)old->history != 5) {
                if (old->fprint != obj->fprint) {
                  old->history = 2;
                } else if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 219647)] != t->pvfp) {
                  old->history = 3;
                }
              }
            } else if (old->fprint != obj->fprint) {
              old->history = 2;
            } else if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 220927)] != t->pvfp) {
              old->history = 3;
            ...
            if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 222539)] != t->pvfp) {
              old->history = 5;
            }
            if (old->fprint != obj->fprint) {
...
static OfrontOPT_Object OfrontOPT_InObj (BYTE mno)
{
  ...
  if (tag == 19) {
    ...
    if ((tag <= 14 || tag == 17) || tag == 18) {
      obj->mode = 3;
      obj->typ = OfrontOPT_impCtxt.ref[__X(tag, 1754, (CHAR*)"OfrontOPT", 230194)];
      obj->conval = OfrontOPT_NewConst();
      ...
      switch (tag) {
        ...
        case 33: 
          ...
          if (s > 0) {
            ...
            i = 0;
            while (i < s) {
              OfrontOPM_SymRCh(&(ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 233000)]);
              i += 1;
            }
          } else {
            ext = NIL;
          ...
          obj->conval->ext = ext;
          break;
        default: __CASECHK((CHAR*)"OfrontOPT", 233983);
      }
    } else if (tag == 20) {
      obj->mode = 5;
      OfrontOPT_InStruct(&obj->typ);
  ...
  if (tag != 19) {
    OfrontOPT_InsertImport(obj, &OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 238124)]->right, &old);
    if (OfrontOPT_impCtxt.self) {
      if (old != NIL) {
...
void OfrontOPT_Import (CHAR *aliasName, INTEGER aliasName__len, CHAR *name, INTEGER name__len, BOOLEAN *done)
{
  OfrontOPT_Object obj = NIL;
  BYTE mno;
  if (__STRCMPCC(name, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPT", 251391) == 0) {
    ...
    OfrontOPT_impCtxt.self = __STRCMPCC(aliasName, (CHAR*)"@self", 6, (CHAR*)"OfrontOPT", 246566) == 0;
    ...
    if (*done) {
      ...
      OfrontOPT_Insert((void*)aliasName, aliasName__len, &obj);
      obj->mode = 11;
      obj->scope = OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 249141)]->right;
      OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 249371)]->link = obj;
      obj->mnolev = (BYTE)(-((INTEGER)mno));
      obj->typ = OfrontOPT_notyp;
...
static void OfrontOPT_OutName (CHAR *name, INTEGER name__len)
{
  ...
  i = 0;
  do {
    ch = name[__X(i, name__len, (CHAR*)"OfrontOPT", 253206)];
    OfrontOPM_SymWCh(ch);
    i += 1;
  } while (!(ch == 0x00));
}
...
static void OfrontOPT_OutMod (SHORTINT mno)
{
  ...
  if ((INTEGER)OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 256255)] < 0) {
    if ((INTEGER)OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 254810)]->sysflag != 0) {
      OfrontOPM_SymWInt(35);
      OfrontOPM_SymWInt(OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 254806)]->sysflag);
    }
    OfrontOPM_SymWInt(16);
    OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 255270)] = OfrontOPT_expCtxt.nofm;
    OfrontOPT_expCtxt.nofm += 1;
    _ptr__66 = OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 255743)]->name;
    OfrontOPT_OutName((void*)_ptr__66->data, _ptr__66->len[0]);
  } else {
    OfrontOPM_SymWInt(-((INTEGER)OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 255999)]));
  }
}
...
static void OfrontOPT_OutHdFld (OfrontOPT_Struct typ, OfrontOPT_Object fld, INTEGER adr)
{
  ...
  } else if ((INTEGER)typ->form == 13 || __STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPT", 260351) == 0) {
...
static void OfrontOPT_OutFlds (OfrontOPT_Object fld, INTEGER adr, BOOLEAN visible)
{
  ...
  while (fld != NIL && (INTEGER)fld->mode == 4) {
    if ((INTEGER)fld->vis != 0 && visible) {
      ...
      _ptr__63 = fld->name;
      OfrontOPT_OutName((void*)_ptr__63->data, _ptr__63->len[0]);
      ...
      case 16: 
        switch (typ->comp) {
          ...
          case 4: 
            ...
            OfrontOPM_SymWInt(18);
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 286975);
        }
        break;
      default: 
...
static void OfrontOPT_OutConstant (OfrontOPT_Object obj)
{
  ...
  switch (f) {
    ...
    case 8: 
      ...
      break;
    case 10: case 18: 
      _ptr__61 = obj->conval->ext;
      OfrontOPT_OutName((void*)_ptr__61->data, _ptr__61->len[0]);
      break;
    case 11: 
      break;
    default: 
      ...
      if ((INTEGER)obj->history == 4) {
        ...
        switch (obj->history) {
          ...
          case 3: 
            ...
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 298495);
        }
        if ((INTEGER)obj->sysflag != 0) {
          OfrontOPM_SymWInt(35);
        ...
        switch (obj->mode) {
          ...
          case 10: 
            ...
            OfrontOPT_OutSign(obj->typ, obj->link);
            _ptr__70 = obj->name;
            OfrontOPT_OutName((void*)_ptr__70->data, _ptr__70->len[0]);
            break;
          case 9: 
            OfrontOPM_SymWInt(33);
            OfrontOPT_OutSign(obj->typ, obj->link);
            ...
            OfrontOPM_SymWInt(j);
            while (i < j) {
              OfrontOPM_SymWCh((ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 305192)]);
              i += 1;
            }
            _ptr__69 = obj->name;
            OfrontOPT_OutName((void*)_ptr__69->data, _ptr__69->len[0]);
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 305169);
        }
      }
    }
...
void OfrontOPT_Export (BOOLEAN *ext, BOOLEAN *new)
{
  ...
  if (OfrontOPM_noerr) {
    ...
    if (OfrontOPM_noerr) {
      ...
      i = 1;
      while ((INTEGER)i < 64) {
        OfrontOPT_expCtxt.locmno[__X(i, 64, (CHAR*)"OfrontOPT", 312120)] = -1;
        i += 1;
      }
...
void OfrontOPT_Init (CHAR *name, INTEGER name__len, CHAR lang, SET opt)
{
  ...
  __STRCOPYCC(name, OfrontOPT_SelfName, __MIN(48, name__len), (CHAR*)"OfrontOPT", 383763);
...
__TDESC(OfrontOPT_ConstDesc__desc, 1, 2) = {__TDFLDS("ConstDesc", 40), {0, 32, -12}};
