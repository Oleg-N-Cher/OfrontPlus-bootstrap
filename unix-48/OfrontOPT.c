    ...
    *typ = OfrontOPT_impCtxt.ref[__X(-tag, 1754, (CHAR*)"OfrontOPT", 198399)];
    ...
    switch (tag) {
      ...
      case 20: 
        ...
        (*typ)->BaseTyp = t;
        break;
      default: __CASECHK((CHAR*)"OfrontOPT", 216831);
    }
    if ((INTEGER)ref == (INTEGER)OfrontOPT_impCtxt.minr) {
      while ((INTEGER)ref < (INTEGER)OfrontOPT_impCtxt.nofr) {
        t = OfrontOPT_impCtxt.ref[__X(ref, 1754, (CHAR*)"OfrontOPT", 217626)];
        OfrontOPT_FPrintStr(t);
        obj = t->strobj;
        if (obj->name != OfrontOPT_null) {
          OfrontOPT_FPrintObj(obj);
        }
        old = OfrontOPT_impCtxt.old[__X(ref, 1754, (CHAR*)"OfrontOPT", 218396)];
        if (old != NIL) {
          t->strobj = old;
          if (OfrontOPT_impCtxt.self) {
            if ((INTEGER)old->mnolev < 0) {
              if ((INTEGER)old->history != 5) {
                if (old->fprint != obj->fprint) {
                  old->history = 2;
                } else if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 219903)] != t->pvfp) {
                  old->history = 3;
                }
              }
            } else if (old->fprint != obj->fprint) {
              old->history = 2;
            } else if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 221183)] != t->pvfp) {
              old->history = 3;
            ...
            if (OfrontOPT_impCtxt.pvfp[__X(ref, 1754, (CHAR*)"OfrontOPT", 222795)] != t->pvfp) {
              old->history = 5;
            }
            if (old->fprint != obj->fprint) {
...
static OfrontOPT_Object OfrontOPT_InObj (BYTE mno)
{
  ...
  if (tag == 19) {
    ...
    if ((tag <= 14 || tag == 17) || tag == 18) {
      obj->mode = 3;
      obj->typ = OfrontOPT_impCtxt.ref[__X(tag, 1754, (CHAR*)"OfrontOPT", 230450)];
      obj->conval = OfrontOPT_NewConst();
      ...
      switch (tag) {
        ...
        case 33: 
          ...
          if (s > 0) {
            ...
            i = 0;
            while (i < s) {
              OfrontOPM_SymRCh(&(ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 233256)]);
              i += 1;
            }
          } else {
            ext = NIL;
          ...
          obj->conval->ext = ext;
          break;
        default: __CASECHK((CHAR*)"OfrontOPT", 234239);
      }
    } else if (tag == 20) {
      obj->mode = 5;
      OfrontOPT_InStruct(&obj->typ);
  ...
  if (tag != 19) {
    OfrontOPT_InsertImport(obj, &OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 238380)]->right, &old);
    if (OfrontOPT_impCtxt.self) {
      if (old != NIL) {
...
void OfrontOPT_Import (CHAR *aliasName, INTEGER aliasName__len, CHAR *name, INTEGER name__len, BOOLEAN *done)
{
  OfrontOPT_Object obj = NIL;
  BYTE mno;
  if (__STRCMPCC(name, (CHAR*)"SYSTEM", 7, (CHAR*)"OfrontOPT", 251647) == 0) {
    ...
    OfrontOPT_impCtxt.self = __STRCMPCC(aliasName, (CHAR*)"@self", 6, (CHAR*)"OfrontOPT", 246822) == 0;
    ...
    if (*done) {
      ...
      OfrontOPT_Insert((void*)aliasName, aliasName__len, &obj);
      obj->mode = 11;
      obj->scope = OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 249397)]->right;
      OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 249627)]->link = obj;
      obj->mnolev = (BYTE)(-((INTEGER)mno));
      obj->typ = OfrontOPT_notyp;
...
static void OfrontOPT_OutName (CHAR *name, INTEGER name__len)
{
  ...
  i = 0;
  do {
    ch = name[__X(i, name__len, (CHAR*)"OfrontOPT", 253462)];
    OfrontOPM_SymWCh(ch);
    i += 1;
  } while (!(ch == 0x00));
}
...
static void OfrontOPT_OutMod (SHORTINT mno)
{
  ...
  if ((INTEGER)OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 256511)] < 0) {
    if ((INTEGER)OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 255066)]->sysflag != 0) {
      OfrontOPM_SymWInt(35);
      OfrontOPM_SymWInt(OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 255062)]->sysflag);
    }
    OfrontOPM_SymWInt(16);
    OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 255526)] = OfrontOPT_expCtxt.nofm;
    OfrontOPT_expCtxt.nofm += 1;
    _ptr__66 = OfrontOPT_GlbMod[__X(mno, 64, (CHAR*)"OfrontOPT", 255999)]->name;
    OfrontOPT_OutName((void*)_ptr__66->data, _ptr__66->len[0]);
  } else {
    OfrontOPM_SymWInt(-((INTEGER)OfrontOPT_expCtxt.locmno[__X(mno, 64, (CHAR*)"OfrontOPT", 256255)]));
  }
}
...
static void OfrontOPT_OutHdFld (OfrontOPT_Struct typ, OfrontOPT_Object fld, INTEGER adr)
{
  ...
  } else if ((INTEGER)typ->form == 13 || __STRCMPCC(fld->name->data, (CHAR*)"@ptr", 5, (CHAR*)"OfrontOPT", 260607) == 0) {
      ...
      case 16: 
        switch (typ->comp) {
          ...
          case 4: 
            ...
            OfrontOPM_SymWInt(18);
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 287231);
        }
        break;
      default: 
      ...
      if ((INTEGER)obj->history == 4) {
        ...
        switch (obj->history) {
          ...
          case 3: 
            ...
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 298751);
        }
        if ((INTEGER)obj->sysflag != 0) {
          OfrontOPM_SymWInt(35);
        ...
        switch (obj->mode) {
          ...
          case 9: 
            ...
            OfrontOPM_SymWInt(j);
            while (i < j) {
              OfrontOPM_SymWCh((ext->data)[__X(i, ext->len[0], (CHAR*)"OfrontOPT", 305448)]);
              i += 1;
            }
            _ptr__69 = obj->name;
            OfrontOPT_OutName((void*)_ptr__69->data, _ptr__69->len[0]);
            break;
          default: __CASECHK((CHAR*)"OfrontOPT", 305425);
        }
      }
    }
...
void OfrontOPT_Export (BOOLEAN *ext, BOOLEAN *new)
{
  ...
  if (OfrontOPM_noerr) {
    ...
    if (OfrontOPM_noerr) {
      ...
      i = 1;
      while ((INTEGER)i < 64) {
        OfrontOPT_expCtxt.locmno[__X(i, 64, (CHAR*)"OfrontOPT", 312376)] = -1;
        i += 1;
      }
...
void OfrontOPT_Init (CHAR *name, INTEGER name__len, CHAR lang, SET opt)
{
  ...
  __STRCOPYCC(name, OfrontOPT_SelfName, __MIN(48, name__len), (CHAR*)"OfrontOPT", 384019);
