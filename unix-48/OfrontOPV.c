...
static void OfrontOPV_Stamp (OfrontOPS_String *s)
{
  ...
  i = 0;
  j = OfrontOPV_stamp;
  while (((*s)->data)[__X(i, (*s)->len[0], (CHAR*)"OfrontOPV", 63761)] != 0x00) {
    res[__X(i, 48, (CHAR*)"OfrontOPV", 63779)] = ((*s)->data)[__X(i, (*s)->len[0], (CHAR*)"OfrontOPV", 63779)];
    i += 1;
  }
  if ((INTEGER)i > 25) {
    i = 25;
  }
  res[__X(i, 48, (CHAR*)"OfrontOPV", 64271)] = '_';
  res[__X((INTEGER)i + 1, 48, (CHAR*)"OfrontOPV", 64288)] = '_';
  i += 2;
  k = 0;
  do {
    n[__X(k, 10, (CHAR*)"OfrontOPV", 64562)] = (CHAR)(__MOD((INTEGER)j, 10) + 48);
    j = (SHORTINT)__DIV((INTEGER)j, 10);
    k += 1;
  } while (!((INTEGER)j == 0));
  do {
    k -= 1;
    res[__X(i, 48, (CHAR*)"OfrontOPV", 64799)] = n[__X(k, 10, (CHAR*)"OfrontOPV", 64799)];
    i += 1;
  } while (!((INTEGER)k == 0));
  res[__X(i, 48, (CHAR*)"OfrontOPV", 65038)] = 0x00;
  if ((*s)->len[0] <= (INTEGER)i) {
    *s = __NEWARR(NIL, 1, 1, 1, 1, (SYSTEM_ARRLEN)((INTEGER)i + 1));
  }
  __STRCOPYCC(res, (*s)->data, __MIN((*s)->len[0], 48), (CHAR*)"OfrontOPV", 65535);
}
  ...
  if (obj != NIL) {
    ...
    if (!exported) {
      if (__IN(mode, 0x60) && (INTEGER)obj->mnolev > 0) {
        obj->entry = obj->name;
        obj->name = __NEWARR(NIL, 1, 1, 1, 1, (SYSTEM_ARRLEN)(__STRLEN(obj->name->data, obj->name->len[0], (CHAR*)"OfrontOPV", 69438) + 12));
        OfrontOPV_Stamp(&obj->name);
      }
      if (__IN(mode, 0x26)) {
        ...
        scope = obj->scope;
        scope->leaf = 1;
        scope->name = __NEWARR(NIL, 1, 1, 1, 1, (SYSTEM_ARRLEN)(__STRLEN(obj->name->data, obj->name->len[0], (CHAR*)"OfrontOPV", 71977) + 12));
        __STRCOPYCC(obj->name->data, scope->name->data, __MIN(scope->name->len[0], obj->name->len[0]), (CHAR*)"OfrontOPV", 72003);
...
static SHORTINT OfrontOPV_Precedence (SHORTINT class, SHORTINT subclass, SHORTINT form, SHORTINT comp)
{
  switch (class) {
    ...
    case 11: 
      switch (subclass) {
        ...
        case 18: case 23: case 24: case 25: case 33: 
          return 10;
          break;
        default: __CASECHK((CHAR*)"OfrontOPV", 85247);
      }
      break;
    case 12: 
      switch (subclass) {
        ...
        case 36: case 37: 
          return 10;
          break;
        default: __CASECHK((CHAR*)"OfrontOPV", 91647);
      }
      break;
    case 10: 
      return 10;
    ...
    case 29: 
      return 10;
      break;
    default: __CASECHK((CHAR*)"OfrontOPV", 93439);
  }
  __RETCHK((CHAR*)"OfrontOPV", 93439);
}
...
static BOOLEAN OfrontOPV_SideEffects (OfrontOPT_Node n)
{
  ...
  __RETCHK((CHAR*)"OfrontOPV", 113407);
}
...
static void OfrontOPV_design_adr (OfrontOPT_Node n, SHORTINT prec, BOOLEAN adr)
{
  ...
  switch (class) {
    ...
    case 13: 
      OfrontOPV_expr(n, -1);
      break;
    default: __CASECHK((CHAR*)"OfrontOPV", 169727);
  }
  if ((INTEGER)prec > (INTEGER)designPrec) {
    OfrontOPM_Write(')');
  }
        ...
        case 28: case 36: case 37: 
          switch (subclass) {
            ...
            case 37: 
              ...
              break;
            default: __CASECHK((CHAR*)"OfrontOPV", 243967);
          }
          OfrontOPV_expr(l, -1);
          OfrontOPM_WriteString((CHAR*)", ", 3);
        ...
        default: 
          ...
          switch (subclass) {
            ...
            case 10: 
              OfrontOPM_WriteString((CHAR*)" || ", 5);
              break;
            default: __CASECHK((CHAR*)"OfrontOPV", 260351);
          }
          OfrontOPV_expr(r, exprPrec);
          break;
      }
...
static void OfrontOPV_StringCopy (OfrontOPT_Node left, OfrontOPT_Node right, BOOLEAN exp)
{
  __ASSERT((INTEGER)right->class != 7, 0, (CHAR*)"OfrontOPV", 305438);
  if ((INTEGER)right->class == 12) {
    __ASSERT((INTEGER)right->subcl == 8, 0, (CHAR*)"OfrontOPV", 305949);
    ...
    while ((INTEGER)right->class == 12) {
      __ASSERT((INTEGER)right->subcl == 8, 0, (CHAR*)"OfrontOPV", 307742);
...
static void OfrontOPV_compStat (OfrontOPT_Node n, BOOLEAN exp)
{
  ...
  while (n != NIL && OfrontOPM_noerr) {
    ...
    __ASSERT((INTEGER)n->class == 19, 0, (CHAR*)"OfrontOPV", 311836);
    l = n->left;
    r = n->right;
    if ((INTEGER)n->subcl == 0) {
      if (__IN(r->typ->form, 0x040400)) {
        ...
        __ASSERT(__IN(l->typ->form, 0x022008), 0, (CHAR*)"OfrontOPV", 314681);
        OfrontOPV_design(l, -1);
        OfrontOPM_WriteString((CHAR*)" = ", 4);
        OfrontOPV_expr(r, -1);
      }
    } else {
      __ASSERT((INTEGER)n->subcl == 1, 0, (CHAR*)"OfrontOPV", 315423);
      __ASSERT((INTEGER)l->typ->BaseTyp->comp == 3, 0, (CHAR*)"OfrontOPV", 315687);
...
static void __45 (OfrontOPT_Node id, SHORTINT cond, OfrontOPT_Node z)
{
  ...
  switch (cond) {
    ...
    case 16: 
      OfrontOPM_WriteString((CHAR*)" < 0", 5);
      break;
    default: __CASECHK((CHAR*)"OfrontOPV", 323618);
  }
}
...
static void OfrontOPV_stat (OfrontOPT_Node n, OfrontOPT_Object outerProc)
{
  ...
  while (n != NIL && OfrontOPM_noerr) {
    ...
    switch (n->class) {
      case 18: 
        __ASSERT(n->obj != NIL, 0, (CHAR*)"OfrontOPV", 326170);
        proc = n->obj;
      ...
      case 19: 
        switch (n->subcl) {
          ...
          case 36: 
            ...
            OfrontOPM_Write(')');
            break;
          default: __CASECHK((CHAR*)"OfrontOPV", 350463);
        }
        break;
      case 13: 
      ...
      case 26: 
        if (OfrontOPM_level == 0) {
          if (OfrontOPV_mainprog) {
            OfrontOPC_DoClose();
            OfrontOPM_WriteString((CHAR*)"__FINI", 7);
          } else {
      ...
      case 30: 
        if (OfrontOPT_SYSimported) {
          ...
          while (ch != 0x00) {
            ...
            i += 1;
            ch = (n->left->conval->ext->data)[__X(i, n->left->conval->ext->len[0], (CHAR*)"OfrontOPV", 372991)];
          }
        }
        break;
      default: __CASECHK((CHAR*)"OfrontOPV", 372991);
    }
...
/*----------------------------------------------------------------------------*/
__TDESC(OfrontOPV_ExitInfo__desc, 2, 0) = {__TDFLDS("ExitInfo", 4), {-4}};
