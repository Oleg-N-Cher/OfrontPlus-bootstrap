...
static void __59 (OfrontOPT_Node *x)
{
  ...
  if ((INTEGER)(*x)->class == 8 || (INTEGER)(*x)->class == 9) {
    ...
    *x = NIL;
    ...
    if ((INTEGER)n > 0) {
      low = tab[0].low;
      high = tab[__X((INTEGER)n - 1, 256, (CHAR*)"OfrontOPP", 370490)].high;
      if (high - low > 512) {
        OfrontOPP_err(209);
      }
    } else {
...
static LONGINT __55 (OfrontOPT_Node A, OfrontOPT_Node B, LONGINT Step)
{
  __ASSERT((INTEGER)A->class == 7 && (INTEGER)B->class == 7, 0, (CHAR*)"OfrontOPP", 395062);
  ...
  if (Nlast == 0) {
    ...
    switch (sgnPostLast) {
      ...
      case 1: 
        cond = 16;
        break;
      default: __CASECHK((CHAR*)"OfrontOPP", 399892);
    }
    ...
    if (OfrontOPP_Sign(Nlast) != sgnPostLast && OfrontOPP_Sign(A->conval->intval + Step) != sgnPostLast) {
      switch (sgnPostLast) {
        ...
        case 1: 
          ...
          break;
        default: __CASECHK((CHAR*)"OfrontOPP", 401995);
      }
    }
  }
  if ((((INTEGER)cond == 0 || (INTEGER)cond == 15) && OfrontOPP_Sign(Nlast) == OfrontOPP_Sign(Step)) && sgnPredLast != OfrontOPP_Sign(Nlast)) {
    switch (OfrontOPP_Sign(Nlast)) {
      ...
      case 1: 
        ...
        break;
      default: __CASECHK((CHAR*)"OfrontOPP", 404544);
    }
  }
  if ((INTEGER)cond != 0) {
    ...
    if ((INTEGER)cond < 0) {
      ...
      (*StatSeq__54_s->idtyp) = ((*StatSeq__54_s->id))->typ;
      __ASSERT((*StatSeq__54_s->idtyp) != NIL, 0, (CHAR*)"OfrontOPP", 407576);
      ...
      while ((INTEGER)OfrontOPP_sym == 40) {
        ...
        if ((INTEGER)((*Block__3_s->obj))->typ->form == 13) {
          ...
          if (((*Block__3_s->typ) != NIL && (INTEGER)((*Block__3_s->typ))->comp == 4) && ((*Block__3_s->typ))->strobj == NIL) {
            __STRCOPYCC(((*Block__3_s->obj))->name->data, (*Block__3_s->rname), __MIN(48, ((*Block__3_s->obj))->name->len[0]), (CHAR*)"OfrontOPP", 512537);
            (*Block__3_s->i) = 0;
            while (((*Block__3_s->rname))[__X((*Block__3_s->i), 48, (CHAR*)"OfrontOPP", 512794)] != 0x00) {
              (*Block__3_s->i) += 1;
            }
            ((*Block__3_s->rname))[__X((*Block__3_s->i), 48, (CHAR*)"OfrontOPP", 513046)] = '^';
            ((*Block__3_s->rname))[__X((INTEGER)(*Block__3_s->i) + 1, 48, (CHAR*)"OfrontOPP", 513064)] = 0x00;
...
void OfrontOPP_Module (OfrontOPT_Node *prog, SET opt)
{
  ...
  if ((INTEGER)OfrontOPP_sym == 33) {
    OfrontOPS_Get(&OfrontOPP_sym);
    if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"foreign", 8, (CHAR*)"OfrontOPP", 537606) == 0) {
      OfrontOPM_opt = OfrontOPM_opt | 0xc000;
      OfrontOPS_Get(&OfrontOPP_sym);
    } else if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"main", 5, (CHAR*)"OfrontOPP", 536063) == 0) {
      OfrontOPM_opt |= __SETOF(10);
      OfrontOPS_Get(&OfrontOPP_sym);
    } else if ((INTEGER)OfrontOPP_sym == 40 && __STRCMPCC(OfrontOPS_name, (CHAR*)"noinit", 7, (CHAR*)"OfrontOPP", 536575) == 0) {
  ...
  if ((INTEGER)OfrontOPP_sym == 40) {
    ...
    OfrontOPS_Get(&OfrontOPP_sym);
    if (__STRLEN(OfrontOPS_name, 48, (CHAR*)"OfrontOPP", 539194) >= 32) {
      OfrontOPP_err(240);
    }
    OfrontOPP_CheckSym(41);
    if ((INTEGER)OfrontOPP_sym == 64) {
      ...
      for (;;) {
        if ((INTEGER)OfrontOPP_sym == 40) {
          __STRCOPYCC(OfrontOPS_name, aliasName, 48, (CHAR*)"OfrontOPP", 540444);
          __STRCOPYCC(aliasName, impName, 48, (CHAR*)"OfrontOPP", 540467);
          OfrontOPS_Get(&OfrontOPP_sym);
          if ((INTEGER)OfrontOPP_sym == 36) {
            OfrontOPS_Get(&OfrontOPP_sym);
            if ((INTEGER)OfrontOPP_sym == 40) {
              __STRCOPYCC(OfrontOPS_name, impName, 48, (CHAR*)"OfrontOPP", 540975);
              OfrontOPS_Get(&OfrontOPP_sym);
            } else {
              OfrontOPP_err(40);
            }
    ...
    if (OfrontOPM_noerr) {
      ...
      *prog = procdec;
      ...
      OfrontOPP_CheckSym(43);
      if ((INTEGER)OfrontOPP_sym == 40) {
        if (__STRCMPCC(OfrontOPS_name, OfrontOPT_SelfName, 48, (CHAR*)"OfrontOPP", 545583) != 0) {
          OfrontOPP_err(4);
        }
        OfrontOPS_Get(&OfrontOPP_sym);
      } else {
